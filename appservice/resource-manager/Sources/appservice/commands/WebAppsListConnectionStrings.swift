...
public protocol WebAppsListConnectionStrings  {
...
internal class ListConnectionStringsCommand : BaseCommand, WebAppsListConnectionStrings {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/connectionstrings/list"
