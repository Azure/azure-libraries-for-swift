...
public protocol WebAppsGetFunctionsAdminToken  {
...
internal class GetFunctionsAdminTokenCommand : BaseCommand, WebAppsGetFunctionsAdminToken {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/functions/admin/token"
