...
public protocol WebAppsListProcessThreads  {
...
internal class ListProcessThreadsCommand : BaseCommand, WebAppsListProcessThreads {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, processId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/processes/{processId}/threads"
