...
// Backup creates a backup of an app.
    internal class BackupCommand : BaseCommand, WebAppsBackup {
    ...
    public var request :  BackupRequestProtocol?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String, request: BackupRequestProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backup"
