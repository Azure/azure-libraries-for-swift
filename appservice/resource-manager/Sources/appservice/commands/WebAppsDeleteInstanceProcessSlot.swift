...
public protocol WebAppsDeleteInstanceProcessSlot  {
...
internal class DeleteInstanceProcessSlotCommand : BaseCommand, WebAppsDeleteInstanceProcessSlot {
    ...
    public init(resourceGroupName: String, name: String, processId: String, slot: String, instanceId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/instances/{instanceId}/processes/{processId}"
