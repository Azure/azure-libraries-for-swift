...
public protocol WebAppsGetConfigurationSnapshotSlot  {
...
// GetConfigurationSnapshotSlot gets a snapshot of the configuration of an app at a previous point in time.
    internal class GetConfigurationSnapshotSlotCommand : BaseCommand, WebAppsGetConfigurationSnapshotSlot {
        ...
        public init(resourceGroupName: String, name: String, snapshotId: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/web/snapshots/{snapshotId}"
