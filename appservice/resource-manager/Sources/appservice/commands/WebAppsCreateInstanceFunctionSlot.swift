...
public protocol WebAppsCreateInstanceFunctionSlot  {
...
internal class CreateInstanceFunctionSlotCommand : BaseCommand, WebAppsCreateInstanceFunctionSlot {
    ...
    public init(resourceGroupName: String, name: String, functionName: String, slot: String, subscriptionId: String, functionEnvelope: FunctionEnvelopeProtocol) {
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(functionEnvelope)
            return encodedValue
        }
