...
// ApplySlotConfigToProduction applies the configuration settings from the target slot onto the current slot.
    internal class ApplySlotConfigToProductionCommand : BaseCommand, WebAppsApplySlotConfigToProduction {
    ...
    public var slotSwapEntity :  CsmSlotEntityProtocol?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String, slotSwapEntity: CsmSlotEntityProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/applySlotConfig"
