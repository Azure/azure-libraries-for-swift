...
public protocol WebAppsGetInstanceProcessModuleSlot  {
...
internal class GetInstanceProcessModuleSlotCommand : BaseCommand, WebAppsGetInstanceProcessModuleSlot {
    ...
    public init(resourceGroupName: String, name: String, processId: String, baseAddress: String, slot: String, instanceId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/instances/{instanceId}/processes/{processId}/modules/{baseAddress}"
