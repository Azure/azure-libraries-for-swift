...
public protocol WebAppsListFunctionSecrets  {
...
internal class ListFunctionSecretsCommand : BaseCommand, WebAppsListFunctionSecrets {
    ...
    public init(resourceGroupName: String, name: String, functionName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/functions/{functionName}/listsecrets"
