...
public protocol AppServiceEnvironmentsListWebWorkerMetricDefinitions  {
...
// ListWebWorkerMetricDefinitions get metric definitions for a worker pool of an App Service Environment.
    internal class ListWebWorkerMetricDefinitionsCommand : BaseCommand, AppServiceEnvironmentsListWebWorkerMetricDefinitions {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, workerPoolName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/workerPools/{workerPoolName}/metricdefinitions"
