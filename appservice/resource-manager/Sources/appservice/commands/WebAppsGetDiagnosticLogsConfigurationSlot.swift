...
public protocol WebAppsGetDiagnosticLogsConfigurationSlot  {
...
// GetDiagnosticLogsConfigurationSlot gets the logging configuration of an app.
    internal class GetDiagnosticLogsConfigurationSlotCommand : BaseCommand, WebAppsGetDiagnosticLogsConfigurationSlot {
