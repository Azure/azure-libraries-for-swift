...
public protocol AppServicePlansListMetricDefintions  {
...
internal class ListMetricDefintionsCommand : BaseCommand, AppServicePlansListMetricDefintions {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverfarms/{name}/metricdefinitions"
