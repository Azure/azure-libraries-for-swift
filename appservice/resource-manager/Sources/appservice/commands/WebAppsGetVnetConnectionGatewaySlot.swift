...
public protocol WebAppsGetVnetConnectionGatewaySlot  {
...
// GetVnetConnectionGatewaySlot gets an app's Virtual Network gateway.
    internal class GetVnetConnectionGatewaySlotCommand : BaseCommand, WebAppsGetVnetConnectionGatewaySlot {
        ...
        public init(resourceGroupName: String, name: String, vnetName: String, gatewayName: String, slot: String, subscriptionId: String) {
