...
public protocol WebAppsListHybridConnectionsSlot  {
...
// ListHybridConnectionsSlot retrieves all Service Bus Hybrid Connections used by this Web App.
    internal class ListHybridConnectionsSlotCommand : BaseCommand, WebAppsListHybridConnectionsSlot {
        ...
        public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/hybridConnectionRelays"
