...
public protocol WebAppsGetBackupConfiguration  {
...
// GetBackupConfiguration gets the backup configuration of an app.
    internal class GetBackupConfigurationCommand : BaseCommand, WebAppsGetBackupConfiguration {
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/backup/list"
