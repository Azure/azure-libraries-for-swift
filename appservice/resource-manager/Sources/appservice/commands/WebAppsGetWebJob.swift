...
public protocol WebAppsGetWebJob  {
...
internal class GetWebJobCommand : BaseCommand, WebAppsGetWebJob {
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/webjobs/{webJobName}"
