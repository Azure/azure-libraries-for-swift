...
public protocol WebAppsGetFunctionsAdminTokenSlot  {
...
// GetFunctionsAdminTokenSlot fetch a short lived token that can be exchanged for a master key.
    internal class GetFunctionsAdminTokenSlotCommand : BaseCommand, WebAppsGetFunctionsAdminTokenSlot {
        ...
        public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/functions/admin/token"
