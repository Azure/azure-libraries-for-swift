...
public protocol AppServiceEnvironmentsListMetrics  {
...
// ListMetrics get global metrics of an App Service Environment.
    internal class ListMetricsCommand : BaseCommand, AppServiceEnvironmentsListMetrics {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/metrics"
