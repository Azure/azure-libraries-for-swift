...
public protocol WebAppsListBackupStatusSecrets  {
...
internal class ListBackupStatusSecretsCommand : BaseCommand, WebAppsListBackupStatusSecrets {
    ...
    public init(resourceGroupName: String, name: String, backupId: String, subscriptionId: String, request: BackupRequestProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backups/{backupId}/list"
