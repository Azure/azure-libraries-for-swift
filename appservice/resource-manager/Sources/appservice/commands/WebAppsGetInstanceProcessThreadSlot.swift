...
internal class GetInstanceProcessThreadSlotCommand : BaseCommand, WebAppsGetInstanceProcessThreadSlot {
    ...
    public init(resourceGroupName: String, name: String, processId: String, threadId: String, slot: String, instanceId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/instances/{instanceId}/processes/{processId}/threads/{threadId}"
