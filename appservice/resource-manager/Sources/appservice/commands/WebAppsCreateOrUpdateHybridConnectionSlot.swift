...
public protocol WebAppsCreateOrUpdateHybridConnectionSlot  {
...
// CreateOrUpdateHybridConnectionSlot creates a new Hybrid Connection using a Service Bus relay.
    internal class CreateOrUpdateHybridConnectionSlotCommand : BaseCommand, WebAppsCreateOrUpdateHybridConnectionSlot {
