...
public protocol WebAppsStartContinuousWebJobSlot  {
...
internal class StartContinuousWebJobSlotCommand : BaseCommand, WebAppsStartContinuousWebJobSlot {
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/continuouswebjobs/{webJobName}/start"
