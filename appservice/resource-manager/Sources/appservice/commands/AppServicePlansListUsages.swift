...
public protocol AppServicePlansListUsages  {
...
internal class ListUsagesCommand : BaseCommand, AppServicePlansListUsages {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverfarms/{name}/usages"
