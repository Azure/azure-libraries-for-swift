...
public protocol WebAppsCreateOrUpdateRelayServiceConnectionSlot  {
...
// one (PATCH).
    internal class CreateOrUpdateRelayServiceConnectionSlotCommand : BaseCommand, WebAppsCreateOrUpdateRelayServiceConnectionSlot {
    ...
    public var connectionEnvelope :  RelayServiceConnectionEntityProtocol?
        ...
        public init(resourceGroupName: String, name: String, entityName: String, slot: String, subscriptionId: String, connectionEnvelope: RelayServiceConnectionEntityProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(connectionEnvelope as? RelayServiceConnectionEntityData)
                return encodedValue
            }
