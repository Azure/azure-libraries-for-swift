...
public protocol CertificateRegistrationProviderListOperations  {
...
extension Commands.CertificateRegistrationProvider {
// ListOperations implements Csm operations Api to exposes the list of available Csm Apis under the resource provider
internal class ListOperationsCommand : BaseCommand, CertificateRegistrationProviderListOperations {
    var nextLink: String?
    ...
    public override init() {
        ...
        self.path = "/providers/Microsoft.CertificateRegistration/operations"
