...
public protocol ServiceValidateMove  {
...
internal class ValidateMoveCommand : BaseCommand, ServiceValidateMove {
    ...
    public init(resourceGroupName: String, subscriptionId: String, moveResourceEnvelope: CsmMoveResourceEnvelopeProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/validateMoveResources"
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(moveResourceEnvelope)
            return encodedValue
        }
