...
public protocol WebAppsRunTriggeredWebJob  {
...
internal class RunTriggeredWebJobCommand : BaseCommand, WebAppsRunTriggeredWebJob {
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/triggeredwebjobs/{webJobName}/run"
