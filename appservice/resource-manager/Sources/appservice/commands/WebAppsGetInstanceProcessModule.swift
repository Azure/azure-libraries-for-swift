...
public protocol WebAppsGetInstanceProcessModule  {
...
// GetInstanceProcessModule get process information by its ID for a specific scaled-out instance in a web site.
    internal class GetInstanceProcessModuleCommand : BaseCommand, WebAppsGetInstanceProcessModule {
        ...
        public init(resourceGroupName: String, name: String, processId: String, baseAddress: String, instanceId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/instances/{instanceId}/processes/{processId}/modules/{baseAddress}"
