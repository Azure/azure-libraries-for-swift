...
public protocol DomainsCreateOrUpdateOwnershipIdentifier  {
...
// existing identifer
internal class CreateOrUpdateOwnershipIdentifierCommand : BaseCommand, DomainsCreateOrUpdateOwnershipIdentifier {
