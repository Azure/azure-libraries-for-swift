...
public protocol WebAppsUpdateVnetConnectionGatewaySlot  {
...
// UpdateVnetConnectionGatewaySlot adds a gateway to a connected Virtual Network (PUT) or updates it (PATCH).
    internal class UpdateVnetConnectionGatewaySlotCommand : BaseCommand, WebAppsUpdateVnetConnectionGatewaySlot {
