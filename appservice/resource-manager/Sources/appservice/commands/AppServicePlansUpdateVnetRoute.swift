...
public protocol AppServicePlansUpdateVnetRoute  {
...
// UpdateVnetRoute create or update a Virtual Network route in an App Service plan.
    internal class UpdateVnetRouteCommand : BaseCommand, AppServicePlansUpdateVnetRoute {
    ...
    public var route :  VnetRouteProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(route as? VnetRouteData)
                return encodedValue
            }
