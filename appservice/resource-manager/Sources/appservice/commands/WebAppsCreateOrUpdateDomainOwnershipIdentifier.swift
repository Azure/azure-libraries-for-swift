...
public protocol WebAppsCreateOrUpdateDomainOwnershipIdentifier  {
...
internal class CreateOrUpdateDomainOwnershipIdentifierCommand : BaseCommand, WebAppsCreateOrUpdateDomainOwnershipIdentifier {
    ...
    public init(resourceGroupName: String, name: String, domainOwnershipIdentifierName: String, subscriptionId: String, domainOwnershipIdentifier: IdentifierProtocol) {
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(domainOwnershipIdentifier)
            return encodedValue
        }
