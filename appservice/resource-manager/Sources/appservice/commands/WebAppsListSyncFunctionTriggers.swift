...
public protocol WebAppsListSyncFunctionTriggers  {
...
internal class ListSyncFunctionTriggersCommand : BaseCommand, WebAppsListSyncFunctionTriggers {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/listsyncfunctiontriggerstatus"
