...
public protocol AppServicePlansGetVnetFromServerFarm  {
...
internal class GetVnetFromServerFarmCommand : BaseCommand, AppServicePlansGetVnetFromServerFarm {
    ...
    public init(resourceGroupName: String, name: String, vnetName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverfarms/{name}/virtualNetworkConnections/{vnetName}"
