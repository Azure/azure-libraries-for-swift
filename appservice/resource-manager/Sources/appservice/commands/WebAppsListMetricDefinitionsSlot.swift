...
public protocol WebAppsListMetricDefinitionsSlot  {
...
// ListMetricDefinitionsSlot gets all metric definitions of an app (or deployment slot, if specified).
    internal class ListMetricDefinitionsSlotCommand : BaseCommand, WebAppsListMetricDefinitionsSlot {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/metricdefinitions"
