...
public protocol WebAppsListInstanceProcessThreads  {
...
internal class ListInstanceProcessThreadsCommand : BaseCommand, WebAppsListInstanceProcessThreads {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, processId: String, instanceId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/instances/{instanceId}/processes/{processId}/threads"
