...
public protocol AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions  {
...
internal class ListMultiRolePoolInstanceMetricDefinitionsCommand : BaseCommand, AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, instance: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/multiRolePools/default/instances/{instance}/metricdefinitions"
