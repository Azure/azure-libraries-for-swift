...
public protocol WebAppsListTriggeredWebJobHistorySlot  {
...
internal class ListTriggeredWebJobHistorySlotCommand : BaseCommand, WebAppsListTriggeredWebJobHistorySlot {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/triggeredwebjobs/{webJobName}/history"
