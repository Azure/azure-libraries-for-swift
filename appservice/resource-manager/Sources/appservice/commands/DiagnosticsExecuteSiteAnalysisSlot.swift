...
// ExecuteSiteAnalysisSlot execute Analysis
    internal class ExecuteSiteAnalysisSlotCommand : BaseCommand, DiagnosticsExecuteSiteAnalysisSlot {
        ...
        public init(resourceGroupName: String, siteName: String, diagnosticCategory: String, analysisName: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slot}/diagnostics/{diagnosticCategory}/analyses/{analysisName}/execute"
