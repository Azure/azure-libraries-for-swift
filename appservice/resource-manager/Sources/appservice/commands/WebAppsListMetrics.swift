...
public protocol WebAppsListMetrics  {
...
internal class ListMetricsCommand : BaseCommand, WebAppsListMetrics {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/metrics"
