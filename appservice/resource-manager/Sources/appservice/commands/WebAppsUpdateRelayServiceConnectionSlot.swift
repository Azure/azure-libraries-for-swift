...
public protocol WebAppsUpdateRelayServiceConnectionSlot  {
...
// (PATCH).
    internal class UpdateRelayServiceConnectionSlotCommand : BaseCommand, WebAppsUpdateRelayServiceConnectionSlot {
