...
public protocol WebAppsGetInstanceMSDeployLogSlot  {
...
// GetInstanceMSDeployLogSlot get the MSDeploy Log for the last MSDeploy operation.
    internal class GetInstanceMSDeployLogSlotCommand : BaseCommand, WebAppsGetInstanceMSDeployLogSlot {
        ...
        public init(resourceGroupName: String, name: String, slot: String, instanceId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/instances/{instanceId}/extensions/MSDeploy/log"
