...
public protocol WebAppsCreateOrUpdate  {
...
internal class CreateOrUpdateCommand : BaseCommand, WebAppsCreateOrUpdate {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String, siteEnvelope: SiteProtocol) {
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(siteEnvelope)
            return encodedValue
        }
