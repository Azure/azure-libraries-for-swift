...
public protocol WebAppsGetMSDeployLog  {
...
// GetMSDeployLog get the MSDeploy Log for the last MSDeploy operation.
    internal class GetMSDeployLogCommand : BaseCommand, WebAppsGetMSDeployLog {
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/extensions/MSDeploy/log"
