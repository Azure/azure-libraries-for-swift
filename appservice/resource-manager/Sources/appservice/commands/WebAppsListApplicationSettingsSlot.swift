...
public protocol WebAppsListApplicationSettingsSlot  {
...
internal class ListApplicationSettingsSlotCommand : BaseCommand, WebAppsListApplicationSettingsSlot {
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/appsettings/list"
