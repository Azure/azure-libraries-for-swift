...
public protocol WebAppsListSlotDifferencesSlot  {
...
internal class ListSlotDifferencesSlotCommand : BaseCommand, WebAppsListSlotDifferencesSlot {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String, slotSwapEntity: CsmSlotEntityProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/slotsdiffs"
