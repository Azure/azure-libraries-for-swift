...
public protocol WebAppsListUsages  {
...
internal class ListUsagesCommand : BaseCommand, WebAppsListUsages {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/usages"
