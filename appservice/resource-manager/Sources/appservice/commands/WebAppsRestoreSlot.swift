...
public protocol WebAppsRestoreSlot  {
...
internal class RestoreSlotCommand : BaseCommand, WebAppsRestoreSlot {
    ...
    public init(resourceGroupName: String, name: String, backupId: String, slot: String, subscriptionId: String, request: RestoreRequestProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/backups/{backupId}/restore"
