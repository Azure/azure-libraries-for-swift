...
public protocol WebAppsListPremierAddOnsSlot  {
...
internal class ListPremierAddOnsSlotCommand : BaseCommand, WebAppsListPremierAddOnsSlot {
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/premieraddons"
