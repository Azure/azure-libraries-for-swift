...
public protocol WebAppsListVnetConnectionsSlot  {
...
internal class ListVnetConnectionsSlotCommand : BaseCommand, WebAppsListVnetConnectionsSlot {
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/virtualNetworkConnections"
