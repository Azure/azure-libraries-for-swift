...
public protocol WebAppsListDomainOwnershipIdentifiers  {
...
internal class ListDomainOwnershipIdentifiersCommand : BaseCommand, WebAppsListDomainOwnershipIdentifiers {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/domainOwnershipIdentifiers"
