...
public protocol WebAppsListApplicationSettings  {
...
internal class ListApplicationSettingsCommand : BaseCommand, WebAppsListApplicationSettings {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/appsettings/list"
