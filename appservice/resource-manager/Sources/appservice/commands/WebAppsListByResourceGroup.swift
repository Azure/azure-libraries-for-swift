...
internal class ListByResourceGroupCommand : BaseCommand, WebAppsListByResourceGroup {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites"
