...
public protocol WebAppsGetInstanceProcessDump  {
...
internal class GetInstanceProcessDumpCommand : BaseCommand, WebAppsGetInstanceProcessDump {
    ...
    public init(resourceGroupName: String, name: String, processId: String, instanceId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/instances/{instanceId}/processes/{processId}/dump"
