...
public protocol WebAppsListVnetConnections  {
...
internal class ListVnetConnectionsCommand : BaseCommand, WebAppsListVnetConnections {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/virtualNetworkConnections"
