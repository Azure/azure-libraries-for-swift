...
public protocol DomainRegistrationProviderListOperations  {
...
extension Commands.DomainRegistrationProvider {
// ListOperations implements Csm operations Api to exposes the list of available Csm Apis under the resource provider
internal class ListOperationsCommand : BaseCommand, DomainRegistrationProviderListOperations {
    var nextLink: String?
    ...
    public override init() {
        ...
        self.path = "/providers/Microsoft.DomainRegistration/operations"
