...
public protocol WebAppsStopWebSiteNetworkTraceSlot  {
...
// StopWebSiteNetworkTraceSlot stop ongoing capturing network packets for the site.
    internal class StopWebSiteNetworkTraceSlotCommand : BaseCommand, WebAppsStopWebSiteNetworkTraceSlot {
        ...
        public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTrace/stop"
