...
public protocol WebAppsStopContinuousWebJob  {
...
internal class StopContinuousWebJobCommand : BaseCommand, WebAppsStopContinuousWebJob {
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/continuouswebjobs/{webJobName}/stop"
