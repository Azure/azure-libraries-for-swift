...
public protocol WebAppsAnalyzeCustomHostname  {
...
// AnalyzeCustomHostname analyze a custom hostname.
    internal class AnalyzeCustomHostnameCommand : BaseCommand, WebAppsAnalyzeCustomHostname {
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/analyzeCustomHostname"
