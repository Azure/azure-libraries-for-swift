...
public protocol WebAppsDeleteContinuousWebJobSlot  {
...
internal class DeleteContinuousWebJobSlotCommand : BaseCommand, WebAppsDeleteContinuousWebJobSlot {
    ...
    public init(resourceGroupName: String, name: String, webJobName: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/continuouswebjobs/{webJobName}"
