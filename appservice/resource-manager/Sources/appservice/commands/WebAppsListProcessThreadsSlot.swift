...
public protocol WebAppsListProcessThreadsSlot  {
...
internal class ListProcessThreadsSlotCommand : BaseCommand, WebAppsListProcessThreadsSlot {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, processId: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/processes/{processId}/threads"
