...
public protocol WebAppsGetBackupConfigurationSlot  {
...
// GetBackupConfigurationSlot gets the backup configuration of an app.
    internal class GetBackupConfigurationSlotCommand : BaseCommand, WebAppsGetBackupConfigurationSlot {
        ...
        public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/backup/list"
