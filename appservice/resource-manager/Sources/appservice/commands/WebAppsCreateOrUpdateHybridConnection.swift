...
public protocol WebAppsCreateOrUpdateHybridConnection  {
...
// CreateOrUpdateHybridConnection creates a new Hybrid Connection using a Service Bus relay.
    internal class CreateOrUpdateHybridConnectionCommand : BaseCommand, WebAppsCreateOrUpdateHybridConnection {
    ...
    public var connectionEnvelope :  HybridConnectionProtocol?
        ...
        public init(resourceGroupName: String, name: String, namespaceName: String, relayName: String, subscriptionId: String, connectionEnvelope: HybridConnectionProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(connectionEnvelope as? HybridConnectionData)
                return encodedValue
            }
