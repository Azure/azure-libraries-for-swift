...
public protocol WebAppsListDomainOwnershipIdentifiersSlot  {
...
internal class ListDomainOwnershipIdentifiersSlotCommand : BaseCommand, WebAppsListDomainOwnershipIdentifiersSlot {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/domainOwnershipIdentifiers"
