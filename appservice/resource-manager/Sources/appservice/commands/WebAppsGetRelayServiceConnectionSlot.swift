...
public protocol WebAppsGetRelayServiceConnectionSlot  {
...
// GetRelayServiceConnectionSlot gets a hybrid connection configuration by its name.
    internal class GetRelayServiceConnectionSlotCommand : BaseCommand, WebAppsGetRelayServiceConnectionSlot {
