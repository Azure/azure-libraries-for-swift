...
public protocol WebAppsDeleteTriggeredWebJob  {
...
// DeleteTriggeredWebJob delete a triggered web job by its ID for an app, or a deployment slot.
    internal class DeleteTriggeredWebJobCommand : BaseCommand, WebAppsDeleteTriggeredWebJob {
        ...
        public init(resourceGroupName: String, name: String, webJobName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/triggeredwebjobs/{webJobName}"
