...
public protocol WebAppsCreateOrUpdateSourceControl  {
...
// outstanding HTTP requests.
    internal class CreateOrUpdateSourceControlCommand : BaseCommand, WebAppsCreateOrUpdateSourceControl {
    ...
    public var siteSourceControl :  SiteSourceControlProtocol?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String, siteSourceControl: SiteSourceControlProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/sourcecontrols/web"
