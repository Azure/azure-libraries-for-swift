...
public protocol AppServiceEnvironmentsListMultiRolePoolSkus  {
...
// ListMultiRolePoolSkus get available SKUs for scaling a multi-role pool.
    internal class ListMultiRolePoolSkusCommand : BaseCommand, AppServiceEnvironmentsListMultiRolePoolSkus {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/multiRolePools/default/skus"
