...
public protocol DiagnosticsGetSiteAnalysis  {
...
// GetSiteAnalysis get Site Analysis
    internal class GetSiteAnalysisCommand : BaseCommand, DiagnosticsGetSiteAnalysis {
        ...
        public init(resourceGroupName: String, siteName: String, diagnosticCategory: String, analysisName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/diagnostics/{diagnosticCategory}/analyses/{analysisName}"
