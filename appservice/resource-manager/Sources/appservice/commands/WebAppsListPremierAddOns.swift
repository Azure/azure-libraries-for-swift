...
public protocol WebAppsListPremierAddOns  {
...
internal class ListPremierAddOnsCommand : BaseCommand, WebAppsListPremierAddOns {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/premieraddons"
