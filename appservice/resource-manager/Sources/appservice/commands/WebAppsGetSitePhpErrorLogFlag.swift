...
public protocol WebAppsGetSitePhpErrorLogFlag  {
...
internal class GetSitePhpErrorLogFlagCommand : BaseCommand, WebAppsGetSitePhpErrorLogFlag {
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/phplogging"
