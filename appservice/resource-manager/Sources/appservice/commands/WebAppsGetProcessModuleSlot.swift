...
public protocol WebAppsGetProcessModuleSlot  {
...
internal class GetProcessModuleSlotCommand : BaseCommand, WebAppsGetProcessModuleSlot {
    ...
    public init(resourceGroupName: String, name: String, processId: String, baseAddress: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/processes/{processId}/modules/{baseAddress}"
