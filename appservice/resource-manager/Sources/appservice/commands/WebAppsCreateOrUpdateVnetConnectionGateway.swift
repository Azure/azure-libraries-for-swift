...
public protocol WebAppsCreateOrUpdateVnetConnectionGateway  {
...
// CreateOrUpdateVnetConnectionGateway adds a gateway to a connected Virtual Network (PUT) or updates it (PATCH).
    internal class CreateOrUpdateVnetConnectionGatewayCommand : BaseCommand, WebAppsCreateOrUpdateVnetConnectionGateway {
    ...
    public var connectionEnvelope :  VnetGatewayProtocol?
        ...
        public init(resourceGroupName: String, name: String, vnetName: String, gatewayName: String, subscriptionId: String, connectionEnvelope: VnetGatewayProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(connectionEnvelope as? VnetGatewayData)
                return encodedValue
            }
