...
public protocol WebAppsListBackups  {
...
internal class ListBackupsCommand : BaseCommand, WebAppsListBackups {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, name: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backups"
