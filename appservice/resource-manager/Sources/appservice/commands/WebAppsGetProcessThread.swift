...
public protocol WebAppsGetProcessThread  {
...
// web site.
    internal class GetProcessThreadCommand : BaseCommand, WebAppsGetProcessThread {
        ...
        public init(resourceGroupName: String, name: String, processId: String, threadId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/processes/{processId}/threads/{threadId}"
