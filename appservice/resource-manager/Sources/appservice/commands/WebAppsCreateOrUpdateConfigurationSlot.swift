...
public protocol WebAppsCreateOrUpdateConfigurationSlot  {
...
internal class CreateOrUpdateConfigurationSlotCommand : BaseCommand, WebAppsCreateOrUpdateConfigurationSlot {
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String, siteConfig: SiteConfigResourceProtocol) {
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(siteConfig)
            return encodedValue
        }
