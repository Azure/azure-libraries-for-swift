...
public protocol WebAppsGetProcessThreadSlot  {
...
// in a web site.
    internal class GetProcessThreadSlotCommand : BaseCommand, WebAppsGetProcessThreadSlot {
        ...
        public init(resourceGroupName: String, name: String, processId: String, threadId: String, slot: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/processes/{processId}/threads/{threadId}"
