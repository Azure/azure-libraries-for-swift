...
public protocol AppServiceEnvironmentsListWebWorkerMetrics  {
...
// ListWebWorkerMetrics get metrics for a worker pool of a AppServiceEnvironment (App Service Environment).
    internal class ListWebWorkerMetricsCommand : BaseCommand, AppServiceEnvironmentsListWebWorkerMetrics {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, workerPoolName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/workerPools/{workerPoolName}/metrics"
