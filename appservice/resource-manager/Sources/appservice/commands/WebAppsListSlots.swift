...
public protocol WebAppsListSlots  {
...
// ListSlots gets an app's deployment slots.
    internal class ListSlotsCommand : BaseCommand, WebAppsListSlots {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots"
