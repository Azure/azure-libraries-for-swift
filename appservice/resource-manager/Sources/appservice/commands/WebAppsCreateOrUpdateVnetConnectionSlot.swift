...
public protocol WebAppsCreateOrUpdateVnetConnectionSlot  {
...
// properties (PATCH).
    internal class CreateOrUpdateVnetConnectionSlotCommand : BaseCommand, WebAppsCreateOrUpdateVnetConnectionSlot {
    ...
    public var connectionEnvelope :  VnetInfoProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(connectionEnvelope as? VnetInfoData)
                return encodedValue
            }
