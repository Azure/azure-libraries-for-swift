...
public protocol WebAppsStartWebSiteNetworkTrace  {
...
// StartWebSiteNetworkTrace start capturing network packets for the site.
    internal class StartWebSiteNetworkTraceCommand : BaseCommand, WebAppsStartWebSiteNetworkTrace {
        ...
        public init(resourceGroupName: String, name: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/networkTrace/start"
