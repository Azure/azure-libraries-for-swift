...
public protocol DiagnosticsGetSiteDetectorSlot  {
...
internal class GetSiteDetectorSlotCommand : BaseCommand, DiagnosticsGetSiteDetectorSlot {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, siteName: String, diagnosticCategory: String, detectorName: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slot}/diagnostics/{diagnosticCategory}/detectors/{detectorName}"
