...
public protocol WebAppsGetProcessDump  {
...
// GetProcessDump get a memory dump of a process by its ID for a specific scaled-out instance in a web site.
    internal class GetProcessDumpCommand : BaseCommand, WebAppsGetProcessDump {
        ...
        public init(resourceGroupName: String, name: String, processId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/processes/{processId}/dump"
