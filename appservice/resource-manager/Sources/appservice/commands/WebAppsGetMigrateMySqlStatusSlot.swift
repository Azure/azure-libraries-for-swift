...
public protocol WebAppsGetMigrateMySqlStatusSlot  {
...
// in app is enabled
internal class GetMigrateMySqlStatusSlotCommand : BaseCommand, WebAppsGetMigrateMySqlStatusSlot {
    ...
    public init(resourceGroupName: String, name: String, slot: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/migratemysql/status"
