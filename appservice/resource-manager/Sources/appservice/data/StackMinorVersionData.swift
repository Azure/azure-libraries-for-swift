...
internal struct StackMinorVersionData : StackMinorVersionProtocol {
...
extension DataFactory {
  public static func createStackMinorVersionProtocol() -> StackMinorVersionProtocol {
    return StackMinorVersionData()
  }
}
