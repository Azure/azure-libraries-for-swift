...
internal struct CsmOperationDisplayData : CsmOperationDisplayProtocol {
...
extension DataFactory {
  public static func createCsmOperationDisplayProtocol() -> CsmOperationDisplayProtocol {
    return CsmOperationDisplayData()
  }
}
