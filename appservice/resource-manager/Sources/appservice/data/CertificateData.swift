...
internal struct CertificateData : CertificateProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createCertificateProtocol(location: String) -> CertificateProtocol {
    return CertificateData(location: location)
  }
}
