...
internal struct ResourceNameAvailabilityData : ResourceNameAvailabilityProtocol {
    public var nameAvailable: Bool?
    public var reason: InAvailabilityReasonTypeEnum?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.reason) {
        self.reason = try container.decode(InAvailabilityReasonTypeEnum?.self, forKey: .reason)
    }
...
extension DataFactory {
  public static func createResourceNameAvailabilityProtocol() -> ResourceNameAvailabilityProtocol {
    return ResourceNameAvailabilityData()
  }
}
