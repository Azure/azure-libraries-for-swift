...
internal struct DomainCollectionData : DomainCollectionProtocol {
    public var value: [DomainProtocol]
  ...
  public init(value: [DomainProtocol])  {
    self.value = value
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.value as! [DomainData], forKey: .value)
    if self._nextLink != nil {try container.encode(self._nextLink, forKey: ._nextLink)}
  }
}

extension DataFactory {
  public static func createDomainCollectionProtocol(value: [DomainProtocol]) -> DomainCollectionProtocol {
    return DomainCollectionData(value: value)
  }
}
