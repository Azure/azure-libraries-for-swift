...
internal struct ResourceCollectionData : ResourceCollectionProtocol {
...
extension DataFactory {
  public static func createResourceCollectionProtocol(value: [String]) -> ResourceCollectionProtocol {
    return ResourceCollectionData(value: value)
  }
}
