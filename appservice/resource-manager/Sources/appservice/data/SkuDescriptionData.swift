...
internal struct SkuDescriptionData : SkuDescriptionProtocol {
    public var name: String?
    public var tier: String?
    public var size: String?
    public var family: String?
    public var capacity: Int32?
    public var skuCapacity: SkuCapacityProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.skuCapacity) {
        self.skuCapacity = try container.decode(SkuCapacityData?.self, forKey: .skuCapacity)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.skuCapacity != nil {try container.encode(self.skuCapacity as! SkuCapacityData?, forKey: .skuCapacity)}
...
extension DataFactory {
  public static func createSkuDescriptionProtocol() -> SkuDescriptionProtocol {
    return SkuDescriptionData()
  }
}
