...
internal struct AdminKeyResultData : AdminKeyResultProtocol {
...
extension DataFactory {
  public static func createAdminKeyResultProtocol() -> AdminKeyResultProtocol {
    return AdminKeyResultData()
  }
}
