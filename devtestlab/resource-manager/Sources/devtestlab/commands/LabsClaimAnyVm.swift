...
public protocol LabsClaimAnyVm  {
...
internal class ClaimAnyVmCommand : BaseCommand, LabsClaimAnyVm {
    ...
    public init(subscriptionId: String, resourceGroupName: String, name: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}/claimAnyVm"
