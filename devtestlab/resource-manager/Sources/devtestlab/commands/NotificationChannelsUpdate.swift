...
public protocol NotificationChannelsUpdate  {
    ...
    var notificationChannel :  NotificationChannelFragmentProtocol?  { get set }
...
// Update modify properties of notificationchannels.
    internal class UpdateCommand : BaseCommand, NotificationChannelsUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var labName : String
        public var name : String
        public var apiVersion = "2016-05-15"
    public var notificationChannel :  NotificationChannelFragmentProtocol?

        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String, notificationChannel: NotificationChannelFragmentProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(notificationChannel as? NotificationChannelFragmentData)
                return encodedValue
            }
