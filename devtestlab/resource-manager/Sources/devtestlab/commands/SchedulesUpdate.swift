...
public protocol SchedulesUpdate  {
...
// Update modify properties of schedules.
    internal class UpdateCommand : BaseCommand, SchedulesUpdate {
    ...
    public var schedule :  ScheduleFragmentProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String, schedule: ScheduleFragmentProtocol) {
