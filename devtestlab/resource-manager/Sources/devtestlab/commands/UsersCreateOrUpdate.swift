...
public protocol UsersCreateOrUpdate  {
...
// CreateOrUpdate create or replace an existing user profile.
    internal class CreateOrUpdateCommand : BaseCommand, UsersCreateOrUpdate {
    ...
    public var user :  UserProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String, user: UserProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(user as? UserData)
                return encodedValue
            }
