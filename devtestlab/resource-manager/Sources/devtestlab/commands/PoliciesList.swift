...
public protocol PoliciesList  {
    ...
    completionHandler: @escaping (ResponseWithContinuationPolicyProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.Policies {
// List list policies in a given policy set.
    internal class ListCommand : BaseCommand, PoliciesList {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, policySetName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets/{policySetName}/policies"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(ResponseWithContinuationPolicyData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: ResponseWithContinuationPolicyData?, error: Error?) in
