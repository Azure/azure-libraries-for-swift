...
public protocol LabsListByResourceGroup  {
...
internal class ListByResourceGroupCommand : BaseCommand, LabsListByResourceGroup {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs"
