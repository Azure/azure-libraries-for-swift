...
public protocol GlobalSchedulesListBySubscription  {
...
internal class ListBySubscriptionCommand : BaseCommand, GlobalSchedulesListBySubscription {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.DevTestLab/schedules"
