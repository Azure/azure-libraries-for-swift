...
// used to cancel polling and any outstanding HTTP requests.
    ...
    public var labVirtualMachine :  LabVirtualMachineProtocol?

        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String, labVirtualMachine: LabVirtualMachineProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(labVirtualMachine as? LabVirtualMachineData)
                return encodedValue
            }
