...
public protocol VirtualMachinesClaim  {
...
// cancel polling and any outstanding HTTP requests.
    internal class ClaimCommand : BaseCommand, VirtualMachinesClaim {
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}/claim"
