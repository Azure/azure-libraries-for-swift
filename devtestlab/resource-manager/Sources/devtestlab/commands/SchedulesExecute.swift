...
public protocol SchedulesExecute  {
...
// outstanding HTTP requests.
    internal class ExecuteCommand : BaseCommand, SchedulesExecute {
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, name: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/schedules/{name}/execute"
