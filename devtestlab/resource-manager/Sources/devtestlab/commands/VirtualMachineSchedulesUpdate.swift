...
public protocol VirtualMachineSchedulesUpdate  {
...
internal class UpdateCommand : BaseCommand, VirtualMachineSchedulesUpdate {
    ...
    public init(subscriptionId: String, resourceGroupName: String, labName: String, virtualMachineName: String, name: String, schedule: ScheduleFragmentProtocol) {
