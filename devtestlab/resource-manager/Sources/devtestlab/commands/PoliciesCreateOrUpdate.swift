...
public protocol PoliciesCreateOrUpdate  {
    ...
    var policy :  PolicyProtocol?  { get set }
...
// CreateOrUpdate create or replace an existing policy.
    internal class CreateOrUpdateCommand : BaseCommand, PoliciesCreateOrUpdate {
    ...
    public var policy :  PolicyProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, labName: String, policySetName: String, name: String, policy: PolicyProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(policy as? PolicyData)
                return encodedValue
            }
