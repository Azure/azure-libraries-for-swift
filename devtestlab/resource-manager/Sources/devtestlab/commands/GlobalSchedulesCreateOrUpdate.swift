...
public protocol GlobalSchedulesCreateOrUpdate  {
...
// CreateOrUpdate create or replace an existing schedule.
    internal class CreateOrUpdateCommand : BaseCommand, GlobalSchedulesCreateOrUpdate {
    ...
    public var schedule :  ScheduleProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, name: String, schedule: ScheduleProtocol) {
