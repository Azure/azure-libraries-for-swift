...
public protocol GlobalSchedulesListByResourceGroup  {
...
internal class ListByResourceGroupCommand : BaseCommand, GlobalSchedulesListByResourceGroup {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules"
