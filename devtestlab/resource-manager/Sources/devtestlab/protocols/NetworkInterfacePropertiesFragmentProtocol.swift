...
import Foundation
// NetworkInterfacePropertiesFragmentProtocol is properties of a network interface.
public protocol NetworkInterfacePropertiesFragmentProtocol : Codable {
     ...
     var sharedPublicIpAddressConfiguration: SharedPublicIpAddressConfigurationFragmentProtocol? { get set }
}
