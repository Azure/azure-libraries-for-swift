...
internal struct ApplicableScheduleData : ApplicableScheduleProtocol, ResourceProtocol {
    public var id: String?
    public var name: String?
    public var type: String?
    public var location: String?
    public var tags: [String:String]?
    public var properties: ApplicableSchedulePropertiesProtocol
...
extension DataFactory {
  public static func createApplicableScheduleProtocol(properties: ApplicableSchedulePropertiesProtocol) -> ApplicableScheduleProtocol {
    return ApplicableScheduleData(properties: properties)
  }
}
