...
internal struct UserIdentityFragmentData : UserIdentityFragmentProtocol {
...
extension DataFactory {
  public static func createUserIdentityFragmentProtocol() -> UserIdentityFragmentProtocol {
    return UserIdentityFragmentData()
  }
}
