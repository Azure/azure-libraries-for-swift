...
internal struct DiskData : DiskProtocol, ResourceProtocol {
  ...
  public init(properties: DiskPropertiesProtocol)  {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.properties as! DiskPropertiesData, forKey: .properties)
  }
}

extension DataFactory {
  public static func createDiskProtocol(properties: DiskPropertiesProtocol) -> DiskProtocol {
    return DiskData(properties: properties)
  }
}
