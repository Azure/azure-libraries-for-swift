...
internal struct SubnetOverrideFragmentData : SubnetOverrideFragmentProtocol {
    ...
    public var sharedPublicIpAddressConfiguration: SubnetSharedPublicIpAddressConfigurationFragmentProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.sharedPublicIpAddressConfiguration) {
        self.sharedPublicIpAddressConfiguration = try container.decode(SubnetSharedPublicIpAddressConfigurationFragmentData?.self, forKey: .sharedPublicIpAddressConfiguration)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.sharedPublicIpAddressConfiguration != nil {try container.encode(self.sharedPublicIpAddressConfiguration as! SubnetSharedPublicIpAddressConfigurationFragmentData?, forKey: .sharedPublicIpAddressConfiguration)}
    if self.virtualNetworkPoolName != nil {try container.encode(self.virtualNetworkPoolName, forKey: .virtualNetworkPoolName)}
  }
}

extension DataFactory {
  public static func createSubnetOverrideFragmentProtocol() -> SubnetOverrideFragmentProtocol {
    return SubnetOverrideFragmentData()
  }
}
