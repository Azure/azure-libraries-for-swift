...
internal struct ComputeVmPropertiesFragmentData : ComputeVmPropertiesFragmentProtocol {
    public var statuses: [ComputeVmInstanceViewStatusFragmentProtocol?]?
    public var osType: String?
    public var vmSize: String?
    public var networkInterfaceId: String?
    public var osDiskId: String?
    public var dataDiskIds: [String]?
    public var dataDisks: [ComputeDataDiskFragmentProtocol?]?
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
      if container.contains(.statuses) {
        self.statuses = try container.decode([ComputeVmInstanceViewStatusFragmentData?]?.self, forKey: .statuses)
    }
    ...
    if container.contains(.dataDisks) {
        self.dataDisks = try container.decode([ComputeDataDiskFragmentData?]?.self, forKey: .dataDisks)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.statuses != nil {try container.encode(self.statuses as! [ComputeVmInstanceViewStatusFragmentData?]?, forKey: .statuses)}
    ...
    if self.dataDisks != nil {try container.encode(self.dataDisks as! [ComputeDataDiskFragmentData?]?, forKey: .dataDisks)}
  }
}

extension DataFactory {
  public static func createComputeVmPropertiesFragmentProtocol() -> ComputeVmPropertiesFragmentProtocol {
    return ComputeVmPropertiesFragmentData()
  }
}
