...
internal struct NetworkInterfacePropertiesData : NetworkInterfacePropertiesProtocol {
    ...
    public var sharedPublicIpAddressConfiguration: SharedPublicIpAddressConfigurationProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.sharedPublicIpAddressConfiguration) {
        self.sharedPublicIpAddressConfiguration = try container.decode(SharedPublicIpAddressConfigurationData?.self, forKey: .sharedPublicIpAddressConfiguration)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.sharedPublicIpAddressConfiguration != nil {try container.encode(self.sharedPublicIpAddressConfiguration as! SharedPublicIpAddressConfigurationData?, forKey: .sharedPublicIpAddressConfiguration)}
  }
}

extension DataFactory {
  public static func createNetworkInterfacePropertiesProtocol() -> NetworkInterfacePropertiesProtocol {
    return NetworkInterfacePropertiesData()
  }
}
