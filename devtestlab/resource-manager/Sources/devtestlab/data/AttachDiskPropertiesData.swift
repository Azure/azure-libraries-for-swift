...
internal struct AttachDiskPropertiesData : AttachDiskPropertiesProtocol {
...
extension DataFactory {
  public static func createAttachDiskPropertiesProtocol() -> AttachDiskPropertiesProtocol {
    return AttachDiskPropertiesData()
  }
}
