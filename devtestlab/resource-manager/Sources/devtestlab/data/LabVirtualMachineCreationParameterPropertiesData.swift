...
internal struct LabVirtualMachineCreationParameterPropertiesData : LabVirtualMachineCreationParameterPropertiesProtocol {
    public var bulkCreationParameters: BulkCreationParametersProtocol?
    ...
    public var uniqueIdentifier: String?
        ...
        enum CodingKeys: String, CodingKey {case bulkCreationParameters = "bulkCreationParameters"
        case notes = "notes"
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
      if container.contains(.bulkCreationParameters) {
        self.bulkCreationParameters = try container.decode(BulkCreationParametersData?.self, forKey: .bulkCreationParameters)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.bulkCreationParameters != nil {try container.encode(self.bulkCreationParameters as! BulkCreationParametersData?, forKey: .bulkCreationParameters)}
...
extension DataFactory {
  public static func createLabVirtualMachineCreationParameterPropertiesProtocol() -> LabVirtualMachineCreationParameterPropertiesProtocol {
    return LabVirtualMachineCreationParameterPropertiesData()
  }
}
