...
internal struct OperationErrorData : OperationErrorProtocol {
...
extension DataFactory {
  public static func createOperationErrorProtocol() -> OperationErrorProtocol {
    return OperationErrorData()
  }
}
