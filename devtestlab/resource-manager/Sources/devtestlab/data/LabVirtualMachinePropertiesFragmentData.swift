...
internal struct LabVirtualMachinePropertiesFragmentData : LabVirtualMachinePropertiesFragmentProtocol {
    ...
    public var artifacts: [ArtifactInstallPropertiesFragmentProtocol?]?
    public var artifactDeploymentStatus: ArtifactDeploymentStatusPropertiesFragmentProtocol?
    public var galleryImageReference: GalleryImageReferenceFragmentProtocol?
    public var computeVm: ComputeVmPropertiesFragmentProtocol?
    public var networkInterface: NetworkInterfacePropertiesFragmentProtocol?
    public var applicableSchedule: ApplicableScheduleFragmentProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.artifacts) {
        self.artifacts = try container.decode([ArtifactInstallPropertiesFragmentData?]?.self, forKey: .artifacts)
    }
    if container.contains(.artifactDeploymentStatus) {
        self.artifactDeploymentStatus = try container.decode(ArtifactDeploymentStatusPropertiesFragmentData?.self, forKey: .artifactDeploymentStatus)
    }
    if container.contains(.galleryImageReference) {
        self.galleryImageReference = try container.decode(GalleryImageReferenceFragmentData?.self, forKey: .galleryImageReference)
    }
    if container.contains(.computeVm) {
        self.computeVm = try container.decode(ComputeVmPropertiesFragmentData?.self, forKey: .computeVm)
    }
    if container.contains(.networkInterface) {
        self.networkInterface = try container.decode(NetworkInterfacePropertiesFragmentData?.self, forKey: .networkInterface)
    }
    if container.contains(.applicableSchedule) {
        self.applicableSchedule = try container.decode(ApplicableScheduleFragmentData?.self, forKey: .applicableSchedule)
    }
...
extension DataFactory {
  public static func createLabVirtualMachinePropertiesFragmentProtocol() -> LabVirtualMachinePropertiesFragmentProtocol {
    return LabVirtualMachinePropertiesFragmentData()
  }
}
