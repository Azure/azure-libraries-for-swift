...
internal struct GalleryImageReferenceData : GalleryImageReferenceProtocol {
...
extension DataFactory {
  public static func createGalleryImageReferenceProtocol() -> GalleryImageReferenceProtocol {
    return GalleryImageReferenceData()
  }
}
