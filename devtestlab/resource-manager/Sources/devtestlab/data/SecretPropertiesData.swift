...
internal struct SecretPropertiesData : SecretPropertiesProtocol {
...
extension DataFactory {
  public static func createSecretPropertiesProtocol() -> SecretPropertiesProtocol {
    return SecretPropertiesData()
  }
}
