...
public protocol ReservationsSummariesListByReservationOrderAndReservation  {
...
internal class ListByReservationOrderAndReservationCommand : BaseCommand, ReservationsSummariesListByReservationOrderAndReservation {
    var nextLink: String?
    ...
    public init(reservationOrderId: String, reservationId: String, grain: DatagrainEnum) {
        ...
        self.path = "/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/reservations/{reservationId}/providers/Microsoft.Consumption/reservationSummaries"
