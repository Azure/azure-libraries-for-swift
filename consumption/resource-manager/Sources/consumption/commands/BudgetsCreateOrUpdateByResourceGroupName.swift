...
public protocol BudgetsCreateOrUpdateByResourceGroupName  {
...
// does not require eTag.
    internal class CreateOrUpdateByResourceGroupNameCommand : BaseCommand, BudgetsCreateOrUpdateByResourceGroupName {
    ...
    public var parameters :  BudgetProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, budgetName: String, parameters: BudgetProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? BudgetData)
                return encodedValue
            }
