...
internal struct SBNamespaceUpdateParametersData : SBNamespaceUpdateParametersProtocol, ResourceNamespacePatchProtocol, ResourceProtocol {
    public var id: String?
    public var name: String?
    public var type: String?
    public var location: String?
    public var tags: [String:String]?
    public var sku: SBSkuProtocol?
    public var properties: SBNamespacePropertiesProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.sku) {
        self.sku = try container.decode(SBSkuData?.self, forKey: .sku)
    }
...
extension DataFactory {
  public static func createSBNamespaceUpdateParametersProtocol() -> SBNamespaceUpdateParametersProtocol {
    return SBNamespaceUpdateParametersData()
  }
}
