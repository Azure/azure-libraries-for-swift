...
internal struct SBNamespaceData : SBNamespaceProtocol, TrackedResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createSBNamespaceProtocol(location: String) -> SBNamespaceProtocol {
    return SBNamespaceData(location: location)
  }
}
