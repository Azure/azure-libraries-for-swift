...
internal class CreateOrUpdateAuthorizationRuleCommand : BaseCommand, NamespacesCreateOrUpdateAuthorizationRule {
    ...
    public init(resourceGroupName: String, namespaceName: String, authorizationRuleName: String, subscriptionId: String, parameters: SBAuthorizationRuleProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/AuthorizationRules/{authorizationRuleName}"
