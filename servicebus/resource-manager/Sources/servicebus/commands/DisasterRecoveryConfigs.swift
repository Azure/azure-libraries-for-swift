...
// DisasterRecoveryConfigs is the azure Service Bus client
import Foundation
...
public struct DisasterRecoveryConfigs {
    ...
    public static func CheckNameAvailabilityMethod(resourceGroupName: String, namespaceName: String, subscriptionId: String, parameters: CheckNameAvailabilityProtocol) -> DisasterRecoveryConfigsCheckNameAvailabilityMethod {
        return CheckNameAvailabilityMethodCommand(resourceGroupName: resourceGroupName, namespaceName: namespaceName, subscriptionId: subscriptionId, parameters: parameters)
    }
