...
public protocol PremiumMessagingRegionsList  {
...
extension Commands.PremiumMessagingRegions {
// List gets the available premium messaging regions for servicebus
internal class ListCommand : BaseCommand, PremiumMessagingRegionsList {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/premiumMessagingRegions"
