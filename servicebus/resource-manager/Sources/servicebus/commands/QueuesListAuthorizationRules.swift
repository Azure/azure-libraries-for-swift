...
public protocol QueuesListAuthorizationRules  {
...
internal class ListAuthorizationRulesCommand : BaseCommand, QueuesListAuthorizationRules {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, namespaceName: String, queueName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules"
