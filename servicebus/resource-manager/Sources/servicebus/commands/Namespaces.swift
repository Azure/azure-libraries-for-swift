...
// Namespaces is the azure Service Bus client
import Foundation
...
public struct Namespaces {
    ...
    public static func CreateOrUpdate(resourceGroupName: String, namespaceName: String, subscriptionId: String, parameters: SBNamespaceProtocol) -> NamespacesCreateOrUpdate {
    ...
    public static func CreateOrUpdateAuthorizationRule(resourceGroupName: String, namespaceName: String, authorizationRuleName: String, subscriptionId: String, parameters: SBAuthorizationRuleProtocol) -> NamespacesCreateOrUpdateAuthorizationRule {
    ...
    public static func Update(resourceGroupName: String, namespaceName: String, subscriptionId: String, parameters: SBNamespaceUpdateParametersProtocol) -> NamespacesUpdate {
