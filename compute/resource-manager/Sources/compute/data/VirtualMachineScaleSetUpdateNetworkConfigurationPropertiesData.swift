...
internal struct VirtualMachineScaleSetUpdateNetworkConfigurationPropertiesData : VirtualMachineScaleSetUpdateNetworkConfigurationPropertiesProtocol {
    ...
    public var ipConfigurations: [VirtualMachineScaleSetUpdateIPConfigurationProtocol?]?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.ipConfigurations) {
        self.ipConfigurations = try container.decode([VirtualMachineScaleSetUpdateIPConfigurationData?]?.self, forKey: .ipConfigurations)
    }
...
extension DataFactory {
  public static func createVirtualMachineScaleSetUpdateNetworkConfigurationPropertiesProtocol() -> VirtualMachineScaleSetUpdateNetworkConfigurationPropertiesProtocol {
    return VirtualMachineScaleSetUpdateNetworkConfigurationPropertiesData()
  }
}
