...
internal struct OSProfileData : OSProfileProtocol {
    ...
    public var secrets: [VaultSecretGroupProtocol?]?
        ...
        enum CodingKeys: String, CodingKey {case computerName = "computerName"
...
extension DataFactory {
  public static func createOSProfileProtocol() -> OSProfileProtocol {
    return OSProfileData()
  }
}
