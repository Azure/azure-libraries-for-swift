...
internal struct SnapshotUpdateData : SnapshotUpdateProtocol, ResourceUpdateProtocol {
...
extension DataFactory {
  public static func createSnapshotUpdateProtocol() -> SnapshotUpdateProtocol {
