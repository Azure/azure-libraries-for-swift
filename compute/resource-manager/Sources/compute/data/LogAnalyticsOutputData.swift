...
internal struct LogAnalyticsOutputData : LogAnalyticsOutputProtocol {
...
extension DataFactory {
  public static func createLogAnalyticsOutputProtocol() -> LogAnalyticsOutputProtocol {
    return LogAnalyticsOutputData()
  }
}
