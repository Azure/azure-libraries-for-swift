...
internal struct VirtualMachineScaleSetData : VirtualMachineScaleSetProtocol, ResourceProtocol {
    ...
    public var properties: VirtualMachineScaleSetPropertiesProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.properties) {
        self.properties = try container.decode(VirtualMachineScaleSetPropertiesData?.self, forKey: .properties)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.properties != nil {try container.encode(self.properties as! VirtualMachineScaleSetPropertiesData?, forKey: .properties)}
...
extension DataFactory {
  public static func createVirtualMachineScaleSetProtocol(location: String) -> VirtualMachineScaleSetProtocol {
    return VirtualMachineScaleSetData(location: location)
  }
}
