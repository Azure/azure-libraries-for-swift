...
public protocol VirtualMachineScaleSetsRestart  {
...
// requests.
    internal class RestartCommand : BaseCommand, VirtualMachineScaleSetsRestart {
    ...
    public var vmInstanceIDs :  VirtualMachineScaleSetVMInstanceIDsProtocol?
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/restart"
