...
public protocol ContainerServicesList  {
...
// container service including state, orchestrator, number of masters and agents, and FQDNs of masters and agents.
    internal class ListCommand : BaseCommand, ContainerServicesList {
        var nextLink: String?
        ...
        public init(subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/containerServices"
