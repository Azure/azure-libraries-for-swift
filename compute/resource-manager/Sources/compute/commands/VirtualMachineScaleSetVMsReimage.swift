...
public protocol VirtualMachineScaleSetVMsReimage  {
...
// polling and any outstanding HTTP requests.
    internal class ReimageCommand : BaseCommand, VirtualMachineScaleSetVMsReimage {
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, instanceId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/reimage"
