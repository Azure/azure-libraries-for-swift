...
public protocol VirtualMachinesGeneralize  {
...
internal class GeneralizeCommand : BaseCommand, VirtualMachinesGeneralize {
    ...
    public init(resourceGroupName: String, vmName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/generalize"
