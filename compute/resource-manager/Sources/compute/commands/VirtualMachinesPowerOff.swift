...
public protocol VirtualMachinesPowerOff  {
...
// outstanding HTTP requests.
    internal class PowerOffCommand : BaseCommand, VirtualMachinesPowerOff {
        ...
        public init(resourceGroupName: String, vmName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/powerOff"
