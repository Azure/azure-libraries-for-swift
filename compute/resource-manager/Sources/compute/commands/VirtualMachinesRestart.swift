...
public protocol VirtualMachinesRestart  {
...
// passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class RestartCommand : BaseCommand, VirtualMachinesRestart {
        ...
        public init(resourceGroupName: String, vmName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/restart"
