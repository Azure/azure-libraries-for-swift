...
// ListByDnsZone lists all record sets in a DNS zone.
    internal class ListByDnsZoneCommand : BaseCommand, RecordSetsListByDnsZone {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, zoneName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/recordsets"
