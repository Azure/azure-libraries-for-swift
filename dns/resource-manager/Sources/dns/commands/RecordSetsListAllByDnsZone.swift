...
public protocol RecordSetsListAllByDnsZone  {
...
// ListAllByDnsZone lists all record sets in a DNS zone.
    internal class ListAllByDnsZoneCommand : BaseCommand, RecordSetsListAllByDnsZone {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, zoneName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/all"
