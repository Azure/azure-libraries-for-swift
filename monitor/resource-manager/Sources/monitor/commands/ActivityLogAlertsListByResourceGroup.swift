...
public protocol ActivityLogAlertsListByResourceGroup  {
...
// ListByResourceGroup get a list of all activity log alerts in a resource group.
    internal class ListByResourceGroupCommand : BaseCommand, ActivityLogAlertsListByResourceGroup {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.insights/activityLogAlerts"
