...
internal struct LocalizableStringData : LocalizableStringProtocol {
...
extension DataFactory {
  public static func createLocalizableStringProtocol(value: String) -> LocalizableStringProtocol {
    return LocalizableStringData(value: value)
  }
}
