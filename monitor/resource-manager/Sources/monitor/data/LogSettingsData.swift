...
internal struct LogSettingsData : LogSettingsProtocol {
...
extension DataFactory {
  public static func createLogSettingsProtocol(enabled: Bool) -> LogSettingsProtocol {
    return LogSettingsData(enabled: enabled)
  }
}
