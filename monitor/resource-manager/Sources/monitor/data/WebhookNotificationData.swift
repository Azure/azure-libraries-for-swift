...
internal struct WebhookNotificationData : WebhookNotificationProtocol {
...
extension DataFactory {
  public static func createWebhookNotificationProtocol() -> WebhookNotificationProtocol {
    return WebhookNotificationData()
  }
}
