...
public protocol ClustersCreate  {
    ...
    var parameters :  ClusterProtocol?  { get set }
...
// will be used to cancel polling and any outstanding HTTP requests.
    ...
    public var parameters :  ClusterProtocol?

        public init(resourceGroupName: String, clusterName: String, subscriptionId: String, parameters: ClusterProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ClusterData)
                return encodedValue
            }
