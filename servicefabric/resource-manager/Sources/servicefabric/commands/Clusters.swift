...
// Clusters is the azure Service Fabric Resource Provider API Client
import Foundation
import azureSwiftRuntime
extension Commands {
public struct Clusters {
    public static func Create(resourceGroupName: String, clusterName: String, subscriptionId: String, parameters: ClusterProtocol) -> ClustersCreate {
