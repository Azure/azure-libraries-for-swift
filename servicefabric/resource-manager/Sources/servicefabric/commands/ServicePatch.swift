...
// Patch updates a service resource with the specified name. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP
// requests.
    internal class PatchCommand : BaseCommand, ServicePatch {
    ...
    public var parameters :  ServiceResourceUpdateProtocol?

        public init(subscriptionId: String, resourceGroupName: String, clusterName: String, applicationName: String, serviceName: String, parameters: ServiceResourceUpdateProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ServiceResourceUpdateData)
                return encodedValue
            }
