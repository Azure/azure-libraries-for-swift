...
internal struct ServicePropertiesBaseData : ServicePropertiesBaseProtocol {
...
extension DataFactory {
  public static func createServicePropertiesBaseProtocol() -> ServicePropertiesBaseProtocol {
    return ServicePropertiesBaseData()
  }
}
