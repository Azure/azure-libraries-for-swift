...
internal struct AvailableOperationDisplayData : AvailableOperationDisplayProtocol {
...
extension DataFactory {
  public static func createAvailableOperationDisplayProtocol() -> AvailableOperationDisplayProtocol {
    return AvailableOperationDisplayData()
  }
}
