...
import Foundation
internal struct BlobsGetHeadersData : BlobsGetHeadersProtocol {
    ...
    public var blobContentMD5: String?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.contentRange) {
        contentRange = try container.decode(String.self, forKey: .contentRange)
    }
    ...
    if container.contains(.blobContentMD5) {
        blobContentMD5 = try container.decode(String.self, forKey: .blobContentMD5)
    }
  }
...
extension DataFactory {
  public static func createBlobsGetHeadersProtocol() -> BlobsGetHeadersProtocol {
    return BlobsGetHeadersData()
  }
}
