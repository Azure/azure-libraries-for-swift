...
internal struct MetricSpecificationData : MetricSpecificationProtocol {
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.dimensions) {
        dimensions = try container.decode([DimensionData?]?.self, forKey: .dimensions)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.dimensions != nil {try container.encode(dimensions as! [DimensionData?]?, forKey: .dimensions)}
