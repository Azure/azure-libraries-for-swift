...
public protocol StorageAccountsListByResourceGroup  {
...
internal class ListByResourceGroupCommand : BaseCommand, StorageAccountsListByResourceGroup {
    public var resourceGroupName : String
    public var subscriptionId : String
    public var apiVersion : String = "2017-06-01"

    public init(resourceGroupName: String, subscriptionId: String, apiVersion: String) {
