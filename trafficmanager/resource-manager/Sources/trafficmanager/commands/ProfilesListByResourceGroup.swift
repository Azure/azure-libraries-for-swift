...
public protocol ProfilesListByResourceGroup  {
...
internal class ListByResourceGroupCommand : BaseCommand, ProfilesListByResourceGroup {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/trafficmanagerprofiles"
