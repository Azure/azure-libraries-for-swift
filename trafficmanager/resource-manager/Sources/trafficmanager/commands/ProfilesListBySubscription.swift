...
public protocol ProfilesListBySubscription  {
...
internal class ListBySubscriptionCommand : BaseCommand, ProfilesListBySubscription {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/trafficmanagerprofiles"
