...
internal struct OperationEntityListResultData : OperationEntityListResultProtocol {
    public var _nextLink: String?
    public var value: [OperationEntityProtocol?]?
...
extension DataFactory {
  public static func createOperationEntityListResultProtocol() -> OperationEntityListResultProtocol {
    return OperationEntityListResultData()
  }
}
