...
internal struct ConnectionMonitorSourceData : ConnectionMonitorSourceProtocol {
...
extension DataFactory {
  public static func createConnectionMonitorSourceProtocol(resourceId: String) -> ConnectionMonitorSourceProtocol {
    return ConnectionMonitorSourceData(resourceId: resourceId)
  }
}
