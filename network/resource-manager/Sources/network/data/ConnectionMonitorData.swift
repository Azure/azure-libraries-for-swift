...
internal struct ConnectionMonitorData : ConnectionMonitorProtocol {
    public var location: String?
    public var tags: [String:String]?
    public var properties: ConnectionMonitorParametersProtocol
...
extension DataFactory {
  public static func createConnectionMonitorProtocol(properties: ConnectionMonitorParametersProtocol) -> ConnectionMonitorProtocol {
    return ConnectionMonitorData(properties: properties)
  }
}
