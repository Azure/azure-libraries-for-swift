...
internal struct ExpressRouteCircuitData : ExpressRouteCircuitProtocol, ResourceProtocol {
    public var id: String?
    public var name: String?
    public var type: String?
    public var location: String?
    public var tags: [String:String]?
    public var sku: ExpressRouteCircuitSkuProtocol?
    public var properties: ExpressRouteCircuitPropertiesFormatProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.sku) {
        self.sku = try container.decode(ExpressRouteCircuitSkuData?.self, forKey: .sku)
    }
    if container.contains(.properties) {
        self.properties = try container.decode(ExpressRouteCircuitPropertiesFormatData?.self, forKey: .properties)
    }
...
extension DataFactory {
  public static func createExpressRouteCircuitProtocol() -> ExpressRouteCircuitProtocol {
    return ExpressRouteCircuitData()
  }
}
