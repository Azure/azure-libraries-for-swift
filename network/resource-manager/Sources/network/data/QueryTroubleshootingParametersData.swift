...
internal struct QueryTroubleshootingParametersData : QueryTroubleshootingParametersProtocol {
...
extension DataFactory {
  public static func createQueryTroubleshootingParametersProtocol(targetResourceId: String) -> QueryTroubleshootingParametersProtocol {
    return QueryTroubleshootingParametersData(targetResourceId: targetResourceId)
  }
}
