...
internal struct VirtualNetworkGatewayConnectionListEntityPropertiesFormatData : VirtualNetworkGatewayConnectionListEntityPropertiesFormatProtocol {
    public var authorizationKey: String?
    public var virtualNetworkGateway1: VirtualNetworkConnectionGatewayReferenceProtocol
    public var virtualNetworkGateway2: VirtualNetworkConnectionGatewayReferenceProtocol?
    public var localNetworkGateway2: VirtualNetworkConnectionGatewayReferenceProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.virtualNetworkGateway1 = try container.decode(VirtualNetworkConnectionGatewayReferenceData.self, forKey: .virtualNetworkGateway1)
    if container.contains(.virtualNetworkGateway2) {
        self.virtualNetworkGateway2 = try container.decode(VirtualNetworkConnectionGatewayReferenceData?.self, forKey: .virtualNetworkGateway2)
    }
    if container.contains(.localNetworkGateway2) {
        self.localNetworkGateway2 = try container.decode(VirtualNetworkConnectionGatewayReferenceData?.self, forKey: .localNetworkGateway2)
    }
...
extension DataFactory {
  public static func createVirtualNetworkGatewayConnectionListEntityPropertiesFormatProtocol(virtualNetworkGateway1: VirtualNetworkConnectionGatewayReferenceProtocol, connectionType: VirtualNetworkGatewayConnectionTypeEnum) -> VirtualNetworkGatewayConnectionListEntityPropertiesFormatProtocol {
    return VirtualNetworkGatewayConnectionListEntityPropertiesFormatData(virtualNetworkGateway1: virtualNetworkGateway1, connectionType: connectionType)
  }
}
