...
internal struct FlowLogStatusParametersData : FlowLogStatusParametersProtocol {
...
extension DataFactory {
  public static func createFlowLogStatusParametersProtocol(targetResourceId: String) -> FlowLogStatusParametersProtocol {
    return FlowLogStatusParametersData(targetResourceId: targetResourceId)
  }
}
