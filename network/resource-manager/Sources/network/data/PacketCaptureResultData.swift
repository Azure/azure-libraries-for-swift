...
internal struct PacketCaptureResultData : PacketCaptureResultProtocol {
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.properties) {
        self.properties = try container.decode(PacketCaptureResultPropertiesData?.self, forKey: .properties)
    }
...
extension DataFactory {
  public static func createPacketCaptureResultProtocol() -> PacketCaptureResultProtocol {
    return PacketCaptureResultData()
  }
}
