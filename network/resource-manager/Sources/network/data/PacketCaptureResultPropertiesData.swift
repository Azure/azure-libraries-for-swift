...
internal struct PacketCaptureResultPropertiesData : PacketCaptureResultPropertiesProtocol, PacketCaptureParametersProtocol {
...
extension DataFactory {
  public static func createPacketCaptureResultPropertiesProtocol(target: String, storageLocation: PacketCaptureStorageLocationProtocol) -> PacketCaptureResultPropertiesProtocol {
    return PacketCaptureResultPropertiesData(target: target, storageLocation: storageLocation)
  }
}
