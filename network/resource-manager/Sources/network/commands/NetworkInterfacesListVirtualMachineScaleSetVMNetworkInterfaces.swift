...
public protocol NetworkInterfacesListVirtualMachineScaleSetVMNetworkInterfaces  {
...
// a virtual machine scale set.
    internal class ListVirtualMachineScaleSetVMNetworkInterfacesCommand : BaseCommand, NetworkInterfacesListVirtualMachineScaleSetVMNetworkInterfaces {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, virtualMachineScaleSetName: String, virtualmachineIndex: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.Compute/virtualMachineScaleSets/{virtualMachineScaleSetName}/virtualMachines/{virtualmachineIndex}/networkInterfaces"
