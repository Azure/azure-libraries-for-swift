...
public protocol LoadBalancersCreateOrUpdate  {
    var headerParameters: [String: String] { get set }
    var resourceGroupName : String { get set }
    var loadBalancerName : String { get set }
    var subscriptionId : String { get set }
    var apiVersion : String { get set }
    var parameters :  LoadBalancerProtocol?  { get set }
...
// passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, LoadBalancersCreateOrUpdate {
        public var resourceGroupName : String
        public var loadBalancerName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var parameters :  LoadBalancerProtocol?

        public init(resourceGroupName: String, loadBalancerName: String, subscriptionId: String, parameters: LoadBalancerProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? LoadBalancerData)
                return encodedValue
            }
