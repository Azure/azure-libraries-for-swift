...
public protocol NetworkWatchersCreateOrUpdate  {
    var headerParameters: [String: String] { get set }
    var resourceGroupName : String { get set }
    var networkWatcherName : String { get set }
    var subscriptionId : String { get set }
    var apiVersion : String { get set }
    var parameters :  NetworkWatcherProtocol?  { get set }
...
// CreateOrUpdate creates or updates a network watcher in the specified resource group.
    internal class CreateOrUpdateCommand : BaseCommand, NetworkWatchersCreateOrUpdate {
        public var resourceGroupName : String
        public var networkWatcherName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var parameters :  NetworkWatcherProtocol?

        public init(resourceGroupName: String, networkWatcherName: String, subscriptionId: String, parameters: NetworkWatcherProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? NetworkWatcherData)
                return encodedValue
            }
