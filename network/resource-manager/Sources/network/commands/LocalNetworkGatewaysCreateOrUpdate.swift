...
public protocol LocalNetworkGatewaysCreateOrUpdate  {
    var headerParameters: [String: String] { get set }
    var resourceGroupName : String { get set }
    var localNetworkGatewayName : String { get set }
    var subscriptionId : String { get set }
    var apiVersion : String { get set }
    var parameters :  LocalNetworkGatewayProtocol?  { get set }
...
// polling and any outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, LocalNetworkGatewaysCreateOrUpdate {
        public var resourceGroupName : String
        public var localNetworkGatewayName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var parameters :  LocalNetworkGatewayProtocol?

        public init(resourceGroupName: String, localNetworkGatewayName: String, subscriptionId: String, parameters: LocalNetworkGatewayProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? LocalNetworkGatewayData)
                return encodedValue
            }
