...
public protocol ApplicationGatewaysCreateOrUpdate  {
    var headerParameters: [String: String] { get set }
    var resourceGroupName : String { get set }
    var applicationGatewayName : String { get set }
    var subscriptionId : String { get set }
    var apiVersion : String { get set }
    var parameters :  ApplicationGatewayProtocol?  { get set }
...
// outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, ApplicationGatewaysCreateOrUpdate {
        public var resourceGroupName : String
        public var applicationGatewayName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var parameters :  ApplicationGatewayProtocol?

        public init(resourceGroupName: String, applicationGatewayName: String, subscriptionId: String, parameters: ApplicationGatewayProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ApplicationGatewayData)
                return encodedValue
            }
