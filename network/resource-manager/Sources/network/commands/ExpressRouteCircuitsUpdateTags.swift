...
public protocol ExpressRouteCircuitsUpdateTags  {
...
internal class UpdateTagsCommand : BaseCommand, ExpressRouteCircuitsUpdateTags {
    ...
    public init(resourceGroupName: String, circuitName: String, subscriptionId: String, parameters: TagsObjectProtocol) {
