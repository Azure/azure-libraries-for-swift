...
public protocol NetworkInterfacesListAll  {
...
internal class ListAllCommand : BaseCommand, NetworkInterfacesListAll {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/networkInterfaces"
