...
public protocol NetworkInterfacesGetVirtualMachineScaleSetIpConfiguration  {
...
// scale set.
internal class GetVirtualMachineScaleSetIpConfigurationCommand : BaseCommand, NetworkInterfacesGetVirtualMachineScaleSetIpConfiguration {
    ...
    public init(resourceGroupName: String, virtualMachineScaleSetName: String, virtualmachineIndex: String, networkInterfaceName: String, ipConfigurationName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.Compute/virtualMachineScaleSets/{virtualMachineScaleSetName}/virtualMachines/{virtualmachineIndex}/networkInterfaces/{networkInterfaceName}/ipConfigurations/{ipConfigurationName}"
