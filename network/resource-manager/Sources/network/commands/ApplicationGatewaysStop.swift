...
// HTTP requests.
    internal class StopCommand : BaseCommand, ApplicationGatewaysStop {
        ...
        public init(resourceGroupName: String, applicationGatewayName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/stop"
