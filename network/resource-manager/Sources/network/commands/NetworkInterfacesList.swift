...
public protocol NetworkInterfacesList  {
...
// List gets all network interfaces in a resource group.
    internal class ListCommand : BaseCommand, NetworkInterfacesList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces"
