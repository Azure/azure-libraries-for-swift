...
public protocol LoadBalancersListAll  {
...
internal class ListAllCommand : BaseCommand, LoadBalancersListAll {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/loadBalancers"
