...
public protocol VirtualNetworkGatewayConnectionsUpdateTags  {
    ...
    completionHandler: @escaping (VirtualNetworkGatewayConnectionListEntityProtocol?, Error?) -> Void) -> Void ;
}
...
// requests.
    internal class UpdateTagsCommand : BaseCommand, VirtualNetworkGatewayConnectionsUpdateTags {
    ...
    public var parameters :  TagsObjectProtocol?
        ...
        public init(resourceGroupName: String, virtualNetworkGatewayConnectionName: String, subscriptionId: String, parameters: TagsObjectProtocol) {
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(VirtualNetworkGatewayConnectionListEntityData?.self, from: data)
                return result;
            }
            throw DecodeError.unknownMimeType
        }
        public func execute(client: RuntimeClient,
            ...
            client.executeAsyncLRO(command: self) {
                (result: VirtualNetworkGatewayConnectionListEntityData?, error: Error?) in
