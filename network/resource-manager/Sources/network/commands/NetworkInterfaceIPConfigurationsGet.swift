...
internal class GetCommand : BaseCommand, NetworkInterfaceIPConfigurationsGet {
    ...
    public init(resourceGroupName: String, networkInterfaceName: String, ipConfigurationName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/ipConfigurations/{ipConfigurationName}"
