...
// List gets all the inbound nat rules in a load balancer.
    internal class ListCommand : BaseCommand, InboundNatRulesList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, loadBalancerName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(InboundNatRuleListResultData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: InboundNatRuleListResultData?, error: Error?) in
