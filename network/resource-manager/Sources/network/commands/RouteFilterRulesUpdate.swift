...
public protocol RouteFilterRulesUpdate  {
    ...
    var routeFilterRuleParameters :  PatchRouteFilterRuleProtocol?  { get set }
...
// requests.
    internal class UpdateCommand : BaseCommand, RouteFilterRulesUpdate {
        public var resourceGroupName : String
        public var routeFilterName : String
        public var ruleName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var routeFilterRuleParameters :  PatchRouteFilterRuleProtocol?

        public init(resourceGroupName: String, routeFilterName: String, ruleName: String, subscriptionId: String, routeFilterRuleParameters: PatchRouteFilterRuleProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(routeFilterRuleParameters as? PatchRouteFilterRuleData)
                return encodedValue
            }
