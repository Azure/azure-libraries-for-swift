...
public protocol ExpressRouteCircuitsCreateOrUpdate  {
    var headerParameters: [String: String] { get set }
    var resourceGroupName : String { get set }
    var circuitName : String { get set }
    var subscriptionId : String { get set }
    var apiVersion : String { get set }
    var parameters :  ExpressRouteCircuitProtocol?  { get set }
...
// requests.
    internal class CreateOrUpdateCommand : BaseCommand, ExpressRouteCircuitsCreateOrUpdate {
        public var resourceGroupName : String
        public var circuitName : String
        public var subscriptionId : String
        public var apiVersion = "2018-01-01"
    public var parameters :  ExpressRouteCircuitProtocol?

        public init(resourceGroupName: String, circuitName: String, subscriptionId: String, parameters: ExpressRouteCircuitProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ExpressRouteCircuitData)
                return encodedValue
            }
