...
public protocol VirtualNetworksCreateOrUpdate  {
    ...
    var parameters :  VirtualNetworkProtocol?  { get set }
...
// polling and any outstanding HTTP requests.
    ...
    public var parameters :  VirtualNetworkProtocol?

        public init(resourceGroupName: String, virtualNetworkName: String, subscriptionId: String, parameters: VirtualNetworkProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? VirtualNetworkData)
                return encodedValue
            }
