...
public protocol SecurityRulesList  {
...
// List gets all security rules in a network security group.
    internal class ListCommand : BaseCommand, SecurityRulesList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, networkSecurityGroupName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}/securityRules"
