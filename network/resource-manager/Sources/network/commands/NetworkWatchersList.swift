...
public protocol NetworkWatchersList  {
...
// List gets all network watchers by resource group.
    internal class ListCommand : BaseCommand, NetworkWatchersList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers"
