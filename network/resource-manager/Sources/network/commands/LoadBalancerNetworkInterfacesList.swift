...
public protocol LoadBalancerNetworkInterfacesList  {
...
extension Commands.LoadBalancerNetworkInterfaces {
// List gets associated load balancer network interfaces.
    internal class ListCommand : BaseCommand, LoadBalancerNetworkInterfacesList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, loadBalancerName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/networkInterfaces"
