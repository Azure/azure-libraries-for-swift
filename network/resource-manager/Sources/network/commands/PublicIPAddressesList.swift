...
public protocol PublicIPAddressesList  {
...
// List gets all public IP addresses in a resource group.
    internal class ListCommand : BaseCommand, PublicIPAddressesList {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPAddresses"
