...
public protocol NetworkWatchersUpdateTags  {
...
// UpdateTags updates a network watcher tags.
    internal class UpdateTagsCommand : BaseCommand, NetworkWatchersUpdateTags {
    ...
    public var parameters :  TagsObjectProtocol?
        ...
        public init(resourceGroupName: String, networkWatcherName: String, subscriptionId: String, parameters: TagsObjectProtocol) {
