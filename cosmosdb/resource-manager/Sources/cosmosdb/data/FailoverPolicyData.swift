...
internal struct FailoverPolicyData : FailoverPolicyProtocol {
...
extension DataFactory {
  public static func createFailoverPolicyProtocol() -> FailoverPolicyProtocol {
    return FailoverPolicyData()
  }
}
