...
internal struct PercentileMetricData : PercentileMetricProtocol {
    public var startTime: Date?
    public var endTime: Date?
    public var timeGrain: String?
    public var unit: UnitTypeEnum?
    public var name: MetricNameProtocol?
    public var metricValues: [PercentileMetricValueProtocol?]?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.metricValues) {
        self.metricValues = try container.decode([PercentileMetricValueData?]?.self, forKey: .metricValues)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.metricValues != nil {try container.encode(self.metricValues as! [PercentileMetricValueData?]?, forKey: .metricValues)}
  }
}

extension DataFactory {
  public static func createPercentileMetricProtocol() -> PercentileMetricProtocol {
    return PercentileMetricData()
  }
}
