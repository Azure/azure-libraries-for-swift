...
public protocol PartitionKeyRangeIdListMetrics  {
...
extension Commands.PartitionKeyRangeId {
// ListMetrics retrieves the metrics determined by the given filter for the given partition key range id.
    internal class ListMetricsCommand : BaseCommand, PartitionKeyRangeIdListMetrics {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String, accountName: String, databaseRid: String, collectionRid: String, partitionKeyRangeId: String, filter: String) {
            self.subscriptionId = subscriptionId
            self.resourceGroupName = resourceGroupName
            self.accountName = accountName
            self.databaseRid = databaseRid
            self.collectionRid = collectionRid
            self.partitionKeyRangeId = partitionKeyRangeId
            self.filter = filter
            super.init()
            self.method = "Get"
            self.isLongRunningOperation = false
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/databases/{databaseRid}/collections/{collectionRid}/partitionKeyRangeId/{partitionKeyRangeId}/metrics"
        ...
        public override func preCall()  {
            ...
            self.pathParameters["{partitionKeyRangeId}"] = String(describing: self.partitionKeyRangeId)
