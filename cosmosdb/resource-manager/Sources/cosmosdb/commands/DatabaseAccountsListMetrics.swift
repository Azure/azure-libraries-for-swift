...
public protocol DatabaseAccountsListMetrics  {
...
internal class ListMetricsCommand : BaseCommand, DatabaseAccountsListMetrics {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String, accountName: String, filter: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/metrics"
