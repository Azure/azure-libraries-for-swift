...
public protocol PercentileSourceTargetListMetrics  {
...
extension Commands.PercentileSourceTarget {
...
internal class ListMetricsCommand : BaseCommand, PercentileSourceTargetListMetrics {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String, accountName: String, sourceRegion: String, targetRegion: String, filter: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/sourceRegion/{sourceRegion}/targetRegion/{targetRegion}/percentile/metrics"
    ...
    public override func preCall()  {
        ...
        self.pathParameters["{sourceRegion}"] = String(describing: self.sourceRegion)
