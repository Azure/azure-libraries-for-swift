...
public protocol DatabaseListUsages  {
...
// ListUsages retrieves the usages (most recent data) for the given database.
    internal class ListUsagesCommand : BaseCommand, DatabaseListUsages {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String, accountName: String, databaseRid: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/databases/{databaseRid}/usages"
