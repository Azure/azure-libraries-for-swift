...
public protocol CollectionRegionListMetrics  {
...
// region.
    internal class ListMetricsCommand : BaseCommand, CollectionRegionListMetrics {
        ...
        public init(subscriptionId: String, resourceGroupName: String, accountName: String, region: String, databaseRid: String, collectionRid: String, filter: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/region/{region}/databases/{databaseRid}/collections/{collectionRid}/metrics"
