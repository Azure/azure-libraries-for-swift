...
public protocol EventHubsListAuthorizationRules  {
...
// ListAuthorizationRules gets the authorization rules for an Event Hub.
    internal class ListAuthorizationRulesCommand : BaseCommand, EventHubsListAuthorizationRules {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, namespaceName: String, eventHubName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/eventhubs/{eventHubName}/authorizationRules"
