...
public protocol EventHubsRegenerateKeys  {
...
// RegenerateKeys regenerates the ACS and SAS connection strings for the Event Hub.
    internal class RegenerateKeysCommand : BaseCommand, EventHubsRegenerateKeys {
    ...
    public var parameters :  RegenerateAccessKeyParametersProtocol?
        ...
        public init(resourceGroupName: String, namespaceName: String, eventHubName: String, authorizationRuleName: String, subscriptionId: String, parameters: RegenerateAccessKeyParametersProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/eventhubs/{eventHubName}/authorizationRules/{authorizationRuleName}/regenerateKeys"
