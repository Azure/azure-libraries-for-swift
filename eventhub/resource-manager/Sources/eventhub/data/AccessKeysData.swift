...
internal struct AccessKeysData : AccessKeysProtocol {
    ...
    public var aliasPrimaryConnectionString: String?
    public var aliasSecondaryConnectionString: String?
    ...
    public var keyName: String?
        ...
        case aliasPrimaryConnectionString = "aliasPrimaryConnectionString"
        case aliasSecondaryConnectionString = "aliasSecondaryConnectionString"
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.aliasPrimaryConnectionString) {
        self.aliasPrimaryConnectionString = try container.decode(String?.self, forKey: .aliasPrimaryConnectionString)
    }
    if container.contains(.aliasSecondaryConnectionString) {
        self.aliasSecondaryConnectionString = try container.decode(String?.self, forKey: .aliasSecondaryConnectionString)
    }
