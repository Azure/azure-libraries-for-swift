...
public protocol VirtualMachineScaleSetVMsRestart  {
...
// requests.
    internal class RestartCommand : BaseCommand, VirtualMachineScaleSetVMsRestart {
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, instanceId: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/restart"
