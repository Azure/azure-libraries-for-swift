...
public protocol VirtualMachineScaleSetsPowerOff  {
...
// used to cancel polling and any outstanding HTTP requests.
    internal class PowerOffCommand : BaseCommand, VirtualMachineScaleSetsPowerOff {
    ...
    public var vmInstanceIDs :  VirtualMachineScaleSetVMInstanceIDsProtocol?
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/poweroff"
