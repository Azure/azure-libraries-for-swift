...
public protocol VirtualMachineScaleSetsDeallocate  {
...
// will be used to cancel polling and any outstanding HTTP requests.
    internal class DeallocateCommand : BaseCommand, VirtualMachineScaleSetsDeallocate {
    ...
    public var vmInstanceIDs :  VirtualMachineScaleSetVMInstanceIDsProtocol?
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/deallocate"
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(vmInstanceIDs as? VirtualMachineScaleSetVMInstanceIDsData?)
                return encodedValue
            }
