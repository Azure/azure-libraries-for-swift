...
public protocol VirtualMachineScaleSetsReimage  {
...
// polling and any outstanding HTTP requests.
    internal class ReimageCommand : BaseCommand, VirtualMachineScaleSetsReimage {
    ...
    public var vmInstanceIDs :  VirtualMachineScaleSetVMInstanceIDsProtocol?
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/reimage"
