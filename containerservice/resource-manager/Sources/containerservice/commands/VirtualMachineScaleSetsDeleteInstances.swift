...
public protocol VirtualMachineScaleSetsDeleteInstances  {
...
// requests.
internal class DeleteInstancesCommand : BaseCommand, VirtualMachineScaleSetsDeleteInstances {
    ...
    public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String, vmInstanceIDs: VirtualMachineScaleSetVMInstanceRequiredIDsProtocol) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/delete"
