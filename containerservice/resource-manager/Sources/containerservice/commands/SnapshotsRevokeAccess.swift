...
public protocol SnapshotsRevokeAccess  {
...
// the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class RevokeAccessCommand : BaseCommand, SnapshotsRevokeAccess {
        ...
        public init(subscriptionId: String, resourceGroupName: String, snapshotName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/snapshots/{snapshotName}/endGetAccess"
