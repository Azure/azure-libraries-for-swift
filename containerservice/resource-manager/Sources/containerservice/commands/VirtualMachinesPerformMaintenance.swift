...
public protocol VirtualMachinesPerformMaintenance  {
...
internal class PerformMaintenanceCommand : BaseCommand, VirtualMachinesPerformMaintenance {
    ...
    public init(resourceGroupName: String, vmName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/performMaintenance"
