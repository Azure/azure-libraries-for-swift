...
public protocol DisksUpdate  {
    var headerParameters: [String: String] { get set }
    var subscriptionId : String { get set }
    var resourceGroupName : String { get set }
    var diskName : String { get set }
    var apiVersion : String { get set }
    var disk :  DiskUpdateProtocol?  { get set }
...
// channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class UpdateCommand : BaseCommand, DisksUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var diskName : String
        public var apiVersion = "2017-03-30"
    public var disk :  DiskUpdateProtocol?

        public init(subscriptionId: String, resourceGroupName: String, diskName: String, disk: DiskUpdateProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(disk as? DiskUpdateData)
                return encodedValue
            }
