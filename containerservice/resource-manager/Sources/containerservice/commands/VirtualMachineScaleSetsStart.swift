...
public protocol VirtualMachineScaleSetsStart  {
...
// requests.
    internal class StartCommand : BaseCommand, VirtualMachineScaleSetsStart {
    ...
    public var vmInstanceIDs :  VirtualMachineScaleSetVMInstanceIDsProtocol?
        ...
        public init(resourceGroupName: String, vmScaleSetName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/start"
