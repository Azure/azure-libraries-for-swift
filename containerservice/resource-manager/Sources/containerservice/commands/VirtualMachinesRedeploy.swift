...
public protocol VirtualMachinesRedeploy  {
...
// requests.
    internal class RedeployCommand : BaseCommand, VirtualMachinesRedeploy {
        ...
        public init(resourceGroupName: String, vmName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/redeploy"
