...
// List lists snapshots under a subscription.
    internal class ListCommand : BaseCommand, SnapshotsList {
        var nextLink: String?
        ...
        public init(subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Compute/snapshots"
