...
internal struct VirtualMachineScaleSetUpdateStorageProfileData : VirtualMachineScaleSetUpdateStorageProfileProtocol {
    public var imageReference: ImageReferenceProtocol?
    public var osDisk: VirtualMachineScaleSetUpdateOSDiskProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.osDisk) {
        self.osDisk = try container.decode(VirtualMachineScaleSetUpdateOSDiskData?.self, forKey: .osDisk)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.osDisk != nil {try container.encode(self.osDisk as! VirtualMachineScaleSetUpdateOSDiskData?, forKey: .osDisk)}
    if self.dataDisks != nil {try container.encode(self.dataDisks as! [VirtualMachineScaleSetDataDiskData?]?, forKey: .dataDisks)}
  }
}

extension DataFactory {
  public static func createVirtualMachineScaleSetUpdateStorageProfileProtocol() -> VirtualMachineScaleSetUpdateStorageProfileProtocol {
    return VirtualMachineScaleSetUpdateStorageProfileData()
  }
}
