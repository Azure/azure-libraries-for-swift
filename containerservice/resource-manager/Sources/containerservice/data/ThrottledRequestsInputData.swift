...
internal struct ThrottledRequestsInputData : ThrottledRequestsInputProtocol, LogAnalyticsInputBaseProtocol {
...
extension DataFactory {
  public static func createThrottledRequestsInputProtocol(blobContainerSasUri: String, fromTime: Date, toTime: Date) -> ThrottledRequestsInputProtocol {
    return ThrottledRequestsInputData(blobContainerSasUri: blobContainerSasUri, fromTime: fromTime, toTime: toTime)
  }
}
