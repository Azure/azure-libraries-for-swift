...
internal struct ResourceSkuCapacityData : ResourceSkuCapacityProtocol {
    public var minimum: Int64?
    public var maximum: Int64?
    public var _default: Int64?
    public var scaleType: ResourceSkuCapacityScaleTypeEnum?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(._default) {
        self._default = try container.decode(Int64?.self, forKey: ._default)
    }
    if container.contains(.scaleType) {
        self.scaleType = try container.decode(ResourceSkuCapacityScaleTypeEnum?.self, forKey: .scaleType)
    }
...
extension DataFactory {
  public static func createResourceSkuCapacityProtocol() -> ResourceSkuCapacityProtocol {
    return ResourceSkuCapacityData()
  }
}
