...
internal struct VirtualMachineScaleSetUpdateIPConfigurationPropertiesData : VirtualMachineScaleSetUpdateIPConfigurationPropertiesProtocol {
    public var subnet: ApiEntityReferenceProtocol?
    public var primary: Bool?
    public var publicIPAddressConfiguration: VirtualMachineScaleSetUpdatePublicIPAddressConfigurationProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.publicIPAddressConfiguration) {
        self.publicIPAddressConfiguration = try container.decode(VirtualMachineScaleSetUpdatePublicIPAddressConfigurationData?.self, forKey: .publicIPAddressConfiguration)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.publicIPAddressConfiguration != nil {try container.encode(self.publicIPAddressConfiguration as! VirtualMachineScaleSetUpdatePublicIPAddressConfigurationData?, forKey: .publicIPAddressConfiguration)}
...
extension DataFactory {
  public static func createVirtualMachineScaleSetUpdateIPConfigurationPropertiesProtocol() -> VirtualMachineScaleSetUpdateIPConfigurationPropertiesProtocol {
    return VirtualMachineScaleSetUpdateIPConfigurationPropertiesData()
  }
}
