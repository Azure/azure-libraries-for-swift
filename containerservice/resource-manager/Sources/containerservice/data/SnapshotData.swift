...
internal struct SnapshotData : SnapshotProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createSnapshotProtocol(location: String) -> SnapshotProtocol {
    return SnapshotData(location: location)
  }
}
