...
public protocol ComputePoliciesCreateOrUpdate  {
    ...
    var parameters :  CreateOrUpdateComputePolicyParametersProtocol?  { get set }
...
// name will be replaced with this new compute policy. An account supports, at most, 50 policies
    internal class CreateOrUpdateCommand : BaseCommand, ComputePoliciesCreateOrUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var accountName : String
        public var computePolicyName : String
        public var apiVersion = "2016-11-01"
    public var parameters :  CreateOrUpdateComputePolicyParametersProtocol?

        public init(subscriptionId: String, resourceGroupName: String, accountName: String, computePolicyName: String, parameters: CreateOrUpdateComputePolicyParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? CreateOrUpdateComputePolicyParametersData)
                return encodedValue
            }
