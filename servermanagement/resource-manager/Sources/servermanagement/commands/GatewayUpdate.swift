...
// requests.
    internal class UpdateCommand : BaseCommand, GatewayUpdate {
    ...
    public var gatewayParameters :  GatewayParametersProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(gatewayParameters as? GatewayParametersData)
                return encodedValue
            }
