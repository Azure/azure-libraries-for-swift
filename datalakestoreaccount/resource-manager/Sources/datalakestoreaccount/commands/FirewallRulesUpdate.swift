...
public protocol FirewallRulesUpdate  {
    ...
    var parameters :  UpdateFirewallRuleParametersProtocol?  { get set }
...
// Update updates the specified firewall rule.
    internal class UpdateCommand : BaseCommand, FirewallRulesUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var accountName : String
        public var firewallRuleName : String
        public var apiVersion = "2016-11-01"
    public var parameters :  UpdateFirewallRuleParametersProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, accountName: String, firewallRuleName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeStore/accounts/{accountName}/firewallRules/{firewallRuleName}"
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? UpdateFirewallRuleParametersData?)
                return encodedValue
            }
