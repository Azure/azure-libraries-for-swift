...
public protocol ServersSuspend  {
...
// outstanding HTTP requests.
    internal class SuspendCommand : BaseCommand, ServersSuspend {
        ...
        public init(resourceGroupName: String, serverName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AnalysisServices/servers/{serverName}/suspend"
