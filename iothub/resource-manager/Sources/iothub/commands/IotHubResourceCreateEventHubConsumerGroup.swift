...
public protocol IotHubResourceCreateEventHubConsumerGroup  {
...
// CreateEventHubConsumerGroup add a consumer group to an Event Hub-compatible endpoint in an IoT hub.
    internal class CreateEventHubConsumerGroupCommand : BaseCommand, IotHubResourceCreateEventHubConsumerGroup {
