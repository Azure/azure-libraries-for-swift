...
// ListByIotHub returns the list of certificates.
    internal class ListByIotHubCommand : BaseCommand, CertificatesListByIotHub {
        ...
        public init(subscriptionId: String, resourceGroupName: String, resourceName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/certificates"
