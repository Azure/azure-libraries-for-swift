...
internal struct IotHubCapacityData : IotHubCapacityProtocol {
    public var minimum: Int64?
    public var maximum: Int64?
    public var _default: Int64?
    public var scaleType: IotHubScaleTypeEnum?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.scaleType) {
        self.scaleType = try container.decode(IotHubScaleTypeEnum?.self, forKey: .scaleType)
    }
...
extension DataFactory {
  public static func createIotHubCapacityProtocol() -> IotHubCapacityProtocol {
    return IotHubCapacityData()
  }
}
