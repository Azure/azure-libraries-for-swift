...
internal struct IotHubNameAvailabilityInfoData : IotHubNameAvailabilityInfoProtocol {
    public var nameAvailable: Bool?
    public var reason: IotHubNameUnavailabilityReasonEnum?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.reason) {
        self.reason = try container.decode(IotHubNameUnavailabilityReasonEnum?.self, forKey: .reason)
    }
...
extension DataFactory {
  public static func createIotHubNameAvailabilityInfoProtocol() -> IotHubNameAvailabilityInfoProtocol {
    return IotHubNameAvailabilityInfoData()
  }
}
