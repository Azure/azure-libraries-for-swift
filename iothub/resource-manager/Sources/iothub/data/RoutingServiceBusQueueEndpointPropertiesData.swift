...
internal struct RoutingServiceBusQueueEndpointPropertiesData : RoutingServiceBusQueueEndpointPropertiesProtocol {
...
extension DataFactory {
  public static func createRoutingServiceBusQueueEndpointPropertiesProtocol(connectionString: String, name: String) -> RoutingServiceBusQueueEndpointPropertiesProtocol {
    return RoutingServiceBusQueueEndpointPropertiesData(connectionString: connectionString, name: name)
  }
}
