...
internal struct BatchAccountCreateParametersData : BatchAccountCreateParametersProtocol {
    public var location: String
    public var tags: [String:String]?
    public var properties: BatchAccountCreatePropertiesProtocol?
...
extension DataFactory {
  public static func createBatchAccountCreateParametersProtocol(location: String) -> BatchAccountCreateParametersProtocol {
    return BatchAccountCreateParametersData(location: location)
  }
}
