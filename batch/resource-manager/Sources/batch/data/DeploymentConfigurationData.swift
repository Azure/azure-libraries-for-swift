...
internal struct DeploymentConfigurationData : DeploymentConfigurationProtocol {
    ...
    public var virtualMachineConfiguration: VirtualMachineConfigurationProtocol?
        ...
        enum CodingKeys: String, CodingKey {case cloudServiceConfiguration = "cloudServiceConfiguration"
...
extension DataFactory {
  public static func createDeploymentConfigurationProtocol() -> DeploymentConfigurationProtocol {
    return DeploymentConfigurationData()
  }
}
