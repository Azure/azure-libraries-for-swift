...
internal struct AutoScaleRunData : AutoScaleRunProtocol {
    ...
    public var error: AutoScaleRunErrorProtocol?
        ...
        enum CodingKeys: String, CodingKey {case evaluationTime = "evaluationTime"
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
          self.evaluationTime = DateConverter.fromString(dateStr: (try container.decode(String?.self, forKey: .evaluationTime)), format: .dateTime)!
...
extension DataFactory {
  public static func createAutoScaleRunProtocol(evaluationTime: Date) -> AutoScaleRunProtocol {
    return AutoScaleRunData(evaluationTime: evaluationTime)
  }
}
