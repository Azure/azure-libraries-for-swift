...
public protocol LocationCheckNameAvailability  {
...
// CheckNameAvailability checks whether the Batch account name is available in the specified region.
    internal class CheckNameAvailabilityCommand : BaseCommand, LocationCheckNameAvailability {
        public var locationName : String
        public var subscriptionId : String
        public var apiVersion = "2017-09-01"
    public var parameters :  CheckNameAvailabilityParametersProtocol?

        public init(locationName: String, subscriptionId: String, parameters: CheckNameAvailabilityParametersProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Batch/locations/{locationName}/checkNameAvailability"
