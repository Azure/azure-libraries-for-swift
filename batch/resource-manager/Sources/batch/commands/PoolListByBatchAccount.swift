...
// ListByBatchAccount lists all of the pools in the specified account.
    internal class ListByBatchAccountCommand : BaseCommand, PoolListByBatchAccount {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, accountName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/pools"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(ListPoolsResultData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: ListPoolsResultData?, error: Error?) in
