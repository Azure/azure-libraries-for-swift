...
// ListByIntegrationAccounts gets a list of integration account agreements.
    internal class ListByIntegrationAccountsCommand : BaseCommand, AgreementsListByIntegrationAccounts {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String, integrationAccountName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/agreements"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(IntegrationAccountAgreementListResultData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: IntegrationAccountAgreementListResultData?, error: Error?) in
