...
public protocol WorkflowsListSwagger  {
...
// ListSwagger gets an OpenAPI definition for the workflow.
    internal class ListSwaggerCommand : BaseCommand, WorkflowsListSwagger {
        ...
        public init(subscriptionId: String, resourceGroupName: String, workflowName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/listSwagger"
