...
public protocol IntegrationAccountsListBySubscription  {
...
internal class ListBySubscriptionCommand : BaseCommand, IntegrationAccountsListBySubscription {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Logic/integrationAccounts"
