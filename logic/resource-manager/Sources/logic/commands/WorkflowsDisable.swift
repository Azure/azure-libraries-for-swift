...
public protocol WorkflowsDisable  {
...
internal class DisableCommand : BaseCommand, WorkflowsDisable {
    ...
    public init(subscriptionId: String, resourceGroupName: String, workflowName: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/disable"
