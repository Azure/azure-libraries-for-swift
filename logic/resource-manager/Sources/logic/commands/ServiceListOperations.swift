...
public protocol ServiceListOperations  {
...
internal class ListOperationsCommand : BaseCommand, ServiceListOperations {
    var nextLink: String?
    ...
    public override init() {
        ...
        self.path = "/providers/Microsoft.Logic/operations"
