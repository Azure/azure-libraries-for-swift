...
public protocol MapsListByIntegrationAccounts  {
    ...
    func execute(client: RuntimeClient,
        completionHandler: @escaping (IntegrationAccountMapListResultProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.Maps {
// ListByIntegrationAccounts gets a list of integration account maps.
internal class ListByIntegrationAccountsCommand : BaseCommand, MapsListByIntegrationAccounts {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String, integrationAccountName: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/maps"
    ...
    public override func returnFunc(data: Data) throws -> Decodable? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let result = try decoder.decode(IntegrationAccountMapListResultData?.self, from: data)
            if var pageDecoder = decoder as? PageDecoder {
    ...
    public func execute(client: RuntimeClient,
        ...
        client.executeAsync(command: self) {
            (result: IntegrationAccountMapListResultData?, error: Error?) in
