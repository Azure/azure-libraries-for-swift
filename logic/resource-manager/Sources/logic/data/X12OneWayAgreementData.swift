...
internal struct X12OneWayAgreementData : X12OneWayAgreementProtocol {
    public var senderBusinessIdentity: BusinessIdentityProtocol
    public var receiverBusinessIdentity: BusinessIdentityProtocol
    public var protocolSettings: X12ProtocolSettingsProtocol
  ...
  public init(senderBusinessIdentity: BusinessIdentityProtocol, receiverBusinessIdentity: BusinessIdentityProtocol, protocolSettings: X12ProtocolSettingsProtocol)  {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.protocolSettings = try container.decode(X12ProtocolSettingsData.self, forKey: .protocolSettings)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.protocolSettings as! X12ProtocolSettingsData, forKey: .protocolSettings)
  }
}

extension DataFactory {
  public static func createX12OneWayAgreementProtocol(senderBusinessIdentity: BusinessIdentityProtocol, receiverBusinessIdentity: BusinessIdentityProtocol, protocolSettings: X12ProtocolSettingsProtocol) -> X12OneWayAgreementProtocol {
    return X12OneWayAgreementData(senderBusinessIdentity: senderBusinessIdentity, receiverBusinessIdentity: receiverBusinessIdentity, protocolSettings: protocolSettings)
  }
}
