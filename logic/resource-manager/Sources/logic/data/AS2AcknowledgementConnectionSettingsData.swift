...
internal struct AS2AcknowledgementConnectionSettingsData : AS2AcknowledgementConnectionSettingsProtocol {
...
extension DataFactory {
  public static func createAS2AcknowledgementConnectionSettingsProtocol(ignoreCertificateNameMismatch: Bool, supportHttpStatusCodeContinue: Bool, keepHttpConnectionAlive: Bool, unfoldHttpHeaders: Bool) -> AS2AcknowledgementConnectionSettingsProtocol {
    return AS2AcknowledgementConnectionSettingsData(ignoreCertificateNameMismatch: ignoreCertificateNameMismatch, supportHttpStatusCodeContinue: supportHttpStatusCodeContinue, keepHttpConnectionAlive: keepHttpConnectionAlive, unfoldHttpHeaders: unfoldHttpHeaders)
  }
}
