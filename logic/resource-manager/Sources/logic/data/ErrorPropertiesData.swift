...
internal struct ErrorPropertiesData : ErrorPropertiesProtocol {
...
extension DataFactory {
  public static func createErrorPropertiesProtocol() -> ErrorPropertiesProtocol {
    return ErrorPropertiesData()
  }
}
