...
internal struct EdifactMessageFilterData : EdifactMessageFilterProtocol {
...
extension DataFactory {
  public static func createEdifactMessageFilterProtocol(messageFilterType: MessageFilterTypeEnum) -> EdifactMessageFilterProtocol {
    return EdifactMessageFilterData(messageFilterType: messageFilterType)
  }
}
