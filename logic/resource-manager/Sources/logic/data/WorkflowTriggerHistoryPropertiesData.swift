...
internal struct WorkflowTriggerHistoryPropertiesData : WorkflowTriggerHistoryPropertiesProtocol {
    ...
    public var run: ResourceReferenceProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.fired) {
        self.fired = try container.decode(Bool?.self, forKey: .fired)
    }
    if container.contains(.run) {
        self.run = try container.decode(ResourceReferenceData?.self, forKey: .run)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.fired != nil {try container.encode(self.fired, forKey: .fired)}
    if self.run != nil {try container.encode(self.run as! ResourceReferenceData?, forKey: .run)}
  }
}

extension DataFactory {
  public static func createWorkflowTriggerHistoryPropertiesProtocol() -> WorkflowTriggerHistoryPropertiesProtocol {
    return WorkflowTriggerHistoryPropertiesData()
  }
}
