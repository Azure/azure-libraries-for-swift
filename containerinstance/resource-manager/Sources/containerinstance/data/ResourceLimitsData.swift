...
internal struct ResourceLimitsData : ResourceLimitsProtocol {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.cpu != nil {try container.encode(self.cpu, forKey: .cpu)}
  }
}

extension DataFactory {
  public static func createResourceLimitsProtocol() -> ResourceLimitsProtocol {
    return ResourceLimitsData()
  }
}
