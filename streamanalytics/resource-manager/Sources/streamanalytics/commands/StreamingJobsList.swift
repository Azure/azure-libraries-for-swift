...
public protocol StreamingJobsList  {
    ...
    completionHandler: @escaping (StreamingJobListResultProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.StreamingJobs {
// List lists all of the streaming jobs in the given subscription.
    internal class ListCommand : BaseCommand, StreamingJobsList {
        var nextLink: String?
        ...
        public init(subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.StreamAnalytics/streamingjobs"
