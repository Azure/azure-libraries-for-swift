...
internal struct UserGetMemberGroupsParametersData : UserGetMemberGroupsParametersProtocol {
...
extension DataFactory {
  public static func createUserGetMemberGroupsParametersProtocol(securityEnabledOnly: Bool) -> UserGetMemberGroupsParametersProtocol {
    return UserGetMemberGroupsParametersData(securityEnabledOnly: securityEnabledOnly)
  }
}
