...
internal struct RecoveryPlanPlannedFailoverInputPropertiesData : RecoveryPlanPlannedFailoverInputPropertiesProtocol {
...
extension DataFactory {
  public static func createRecoveryPlanPlannedFailoverInputPropertiesProtocol(failoverDirection: PossibleOperationsDirectionsEnum) -> RecoveryPlanPlannedFailoverInputPropertiesProtocol {
    return RecoveryPlanPlannedFailoverInputPropertiesData(failoverDirection: failoverDirection)
  }
}
