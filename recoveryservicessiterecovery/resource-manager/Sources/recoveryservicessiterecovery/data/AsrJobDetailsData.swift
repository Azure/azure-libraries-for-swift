...
internal struct AsrJobDetailsData : AsrJobDetailsProtocol, JobDetailsProtocol {
...
extension DataFactory {
  public static func createAsrJobDetailsProtocol() -> AsrJobDetailsProtocol {
    return AsrJobDetailsData()
  }
}
