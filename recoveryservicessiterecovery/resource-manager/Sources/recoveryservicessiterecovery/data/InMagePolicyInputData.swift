...
internal struct InMagePolicyInputData : InMagePolicyInputProtocol, PolicyProviderSpecificInputProtocol {
...
extension DataFactory {
  public static func createInMagePolicyInputProtocol(multiVmSyncStatus: SetMultiVmSyncStatusEnum) -> InMagePolicyInputProtocol {
    return InMagePolicyInputData(multiVmSyncStatus: multiVmSyncStatus)
  }
}
