...
internal struct AlertPropertiesData : AlertPropertiesProtocol {
...
extension DataFactory {
  public static func createAlertPropertiesProtocol() -> AlertPropertiesProtocol {
    return AlertPropertiesData()
  }
}
