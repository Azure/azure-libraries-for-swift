...
internal struct InMageAzureV2PolicyInputData : InMageAzureV2PolicyInputProtocol, PolicyProviderSpecificInputProtocol {
...
extension DataFactory {
  public static func createInMageAzureV2PolicyInputProtocol(multiVmSyncStatus: SetMultiVmSyncStatusEnum) -> InMageAzureV2PolicyInputProtocol {
    return InMageAzureV2PolicyInputData(multiVmSyncStatus: multiVmSyncStatus)
  }
}
