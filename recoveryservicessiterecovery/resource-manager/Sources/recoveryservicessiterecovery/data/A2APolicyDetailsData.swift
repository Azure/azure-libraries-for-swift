...
internal struct A2APolicyDetailsData : A2APolicyDetailsProtocol, PolicyProviderSpecificDetailsProtocol {
...
extension DataFactory {
  public static func createA2APolicyDetailsProtocol() -> A2APolicyDetailsProtocol {
    return A2APolicyDetailsData()
  }
}
