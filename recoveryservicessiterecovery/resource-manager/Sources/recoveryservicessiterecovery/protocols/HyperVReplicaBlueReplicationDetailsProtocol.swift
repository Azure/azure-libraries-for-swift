...
import Foundation
// HyperVReplicaBlueReplicationDetailsProtocol is hyperV replica 2012 R2 (Blue) replication details.
public protocol HyperVReplicaBlueReplicationDetailsProtocol : ReplicationProviderSpecificSettingsProtocol {
