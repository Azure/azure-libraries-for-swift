...
public protocol ReplicationProtectedItemsApplyRecoveryPoint  {
    ...
    var applyRecoveryPointInput :  ApplyRecoveryPointInputProtocol?  { get set }
...
// used to cancel polling and any outstanding HTTP requests.
    internal class ApplyRecoveryPointCommand : BaseCommand, ReplicationProtectedItemsApplyRecoveryPoint {
    ...
    public var applyRecoveryPointInput :  ApplyRecoveryPointInputProtocol?

        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String, applyRecoveryPointInput: ApplyRecoveryPointInputProtocol) {
            ...
            self.applyRecoveryPointInput = applyRecoveryPointInput
            super.init()
            self.method = "Post"
            self.isLongRunningOperation = true
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/applyRecoveryPoint"
        ...
        public override func preCall()  {
            ...
            self.body = applyRecoveryPointInput
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(applyRecoveryPointInput as? ApplyRecoveryPointInputData)
                return encodedValue
            }
