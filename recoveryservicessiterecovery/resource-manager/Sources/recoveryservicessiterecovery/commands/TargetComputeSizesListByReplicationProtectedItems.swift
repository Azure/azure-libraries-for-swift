...
public protocol TargetComputeSizesListByReplicationProtectedItems  {
    ...
    completionHandler: @escaping (TargetComputeSizeCollectionProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.TargetComputeSizes {
// ListByReplicationProtectedItems lists the available target compute sizes for a replication protected item.
    internal class ListByReplicationProtectedItemsCommand : BaseCommand, TargetComputeSizesListByReplicationProtectedItems {
        var nextLink: String?
        ...
        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/targetComputeSizes"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(TargetComputeSizeCollectionData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: TargetComputeSizeCollectionData?, error: Error?) in
