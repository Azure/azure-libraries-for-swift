...
public protocol ReplicationvCentersList  {
...
// List lists the vCenter servers registered in the vault.
    internal class ListCommand : BaseCommand, ReplicationvCentersList {
        var nextLink: String?
        ...
        public init(resourceName: String, resourceGroupName: String, subscriptionId: String) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationvCenters"
