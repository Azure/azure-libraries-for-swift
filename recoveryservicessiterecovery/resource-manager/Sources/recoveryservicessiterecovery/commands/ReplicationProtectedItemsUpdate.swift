...
public protocol ReplicationProtectedItemsUpdate  {
    ...
    var updateProtectionInput :  UpdateReplicationProtectedItemInputProtocol?  { get set }
...
// polling and any outstanding HTTP requests.
    internal class UpdateCommand : BaseCommand, ReplicationProtectedItemsUpdate {
    ...
    public var updateProtectionInput :  UpdateReplicationProtectedItemInputProtocol?

        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String, updateProtectionInput: UpdateReplicationProtectedItemInputProtocol) {
            ...
            self.updateProtectionInput = updateProtectionInput
            super.init()
            self.method = "Patch"
        ...
        public override func preCall()  {
            ...
            self.body = updateProtectionInput
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(updateProtectionInput as? UpdateReplicationProtectedItemInputData)
                return encodedValue
            }
