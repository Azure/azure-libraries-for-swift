...
public protocol ReplicationFabricsMigrateToAad  {
...
// outstanding HTTP requests.
    internal class MigrateToAadCommand : BaseCommand, ReplicationFabricsMigrateToAad {
        ...
        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/migratetoaad"
