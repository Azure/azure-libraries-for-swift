...
public protocol ReplicationProtectedItemsFailoverCommit  {
...
// polling and any outstanding HTTP requests.
    internal class FailoverCommitCommand : BaseCommand, ReplicationProtectedItemsFailoverCommit {
        ...
        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/failoverCommit"
