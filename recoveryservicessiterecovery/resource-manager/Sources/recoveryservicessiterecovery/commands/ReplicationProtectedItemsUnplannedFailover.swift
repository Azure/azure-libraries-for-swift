...
public protocol ReplicationProtectedItemsUnplannedFailover  {
    ...
    var failoverInput :  UnplannedFailoverInputProtocol?  { get set }
...
// polling and any outstanding HTTP requests.
    internal class UnplannedFailoverCommand : BaseCommand, ReplicationProtectedItemsUnplannedFailover {
    ...
    public var failoverInput :  UnplannedFailoverInputProtocol?

        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String, failoverInput: UnplannedFailoverInputProtocol) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/unplannedFailover"
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(failoverInput as? UnplannedFailoverInputData)
                return encodedValue
            }
