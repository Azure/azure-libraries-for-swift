...
public protocol ReplicationStorageClassificationsListByReplicationFabrics  {
...
internal class ListByReplicationFabricsCommand : BaseCommand, ReplicationStorageClassificationsListByReplicationFabrics {
    var nextLink: String?
    ...
    public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String) {
        ...
        self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationStorageClassifications"
