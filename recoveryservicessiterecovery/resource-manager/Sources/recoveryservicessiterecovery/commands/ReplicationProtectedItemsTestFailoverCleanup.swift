...
public protocol ReplicationProtectedItemsTestFailoverCleanup  {
    ...
    var cleanupInput :  TestFailoverCleanupInputProtocol?  { get set }
...
// polling and any outstanding HTTP requests.
    internal class TestFailoverCleanupCommand : BaseCommand, ReplicationProtectedItemsTestFailoverCleanup {
    ...
    public var cleanupInput :  TestFailoverCleanupInputProtocol?

        public init(resourceName: String, resourceGroupName: String, subscriptionId: String, fabricName: String, protectionContainerName: String, replicatedProtectedItemName: String, cleanupInput: TestFailoverCleanupInputProtocol) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/testFailoverCleanup"
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(cleanupInput as? TestFailoverCleanupInputData)
                return encodedValue
            }
