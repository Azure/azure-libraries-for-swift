...
public protocol ReplicationJobsCancel  {
...
// requests.
internal class CancelCommand : BaseCommand, ReplicationJobsCancel {
    ...
    public init(resourceName: String, resourceGroupName: String, subscriptionId: String, jobName: String) {
        ...
        self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationJobs/{jobName}/cancel"
