...
public protocol ReplicationStorageClassificationMappingsList  {
...
// List lists the storage classification mappings in the vault.
    internal class ListCommand : BaseCommand, ReplicationStorageClassificationMappingsList {
        var nextLink: String?
        ...
        public init(resourceName: String, resourceGroupName: String, subscriptionId: String) {
            ...
            self.path = "/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationStorageClassificationMappings"
