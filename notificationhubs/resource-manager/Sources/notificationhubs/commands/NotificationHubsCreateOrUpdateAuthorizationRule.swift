...
public protocol NotificationHubsCreateOrUpdateAuthorizationRule  {
...
// CreateOrUpdateAuthorizationRule creates/Updates an authorization rule for a NotificationHub
    internal class CreateOrUpdateAuthorizationRuleCommand : BaseCommand, NotificationHubsCreateOrUpdateAuthorizationRule {
    ...
    public var parameters :  SharedAccessAuthorizationRuleCreateOrUpdateParametersProtocol?
        ...
        public init(resourceGroupName: String, namespaceName: String, notificationHubName: String, authorizationRuleName: String, subscriptionId: String, parameters: SharedAccessAuthorizationRuleCreateOrUpdateParametersProtocol) {
