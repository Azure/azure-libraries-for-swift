...
internal struct ResourceListKeysData : ResourceListKeysProtocol {
...
extension DataFactory {
  public static func createResourceListKeysProtocol() -> ResourceListKeysProtocol {
    return ResourceListKeysData()
  }
}
