...
internal struct NamespaceResourceData : NamespaceResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createNamespaceResourceProtocol(location: String) -> NamespaceResourceProtocol {
    return NamespaceResourceData(location: location)
  }
}
