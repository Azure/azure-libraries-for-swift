...
internal struct OperationStatusData : OperationStatusProtocol {
    ...
    public var status: OperationStatusValuesEnum?
    public var startTime: Date?
    public var endTime: Date?
    public var error: OperationStatusErrorProtocol?
    public var properties: OperationStatusExtendedInfoProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.status) {
        self.status = try container.decode(OperationStatusValuesEnum?.self, forKey: .status)
    }
    ...
    if container.contains(.error) {
        self.error = try container.decode(OperationStatusErrorData?.self, forKey: .error)
    }
