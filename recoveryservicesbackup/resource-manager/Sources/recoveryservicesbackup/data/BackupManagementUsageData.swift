...
internal struct BackupManagementUsageData : BackupManagementUsageProtocol {
...
extension DataFactory {
  public static func createBackupManagementUsageProtocol() -> BackupManagementUsageProtocol {
    return BackupManagementUsageData()
  }
}
