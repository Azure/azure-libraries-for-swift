...
internal struct TargetAFSRestoreInfoData : TargetAFSRestoreInfoProtocol {
...
extension DataFactory {
  public static func createTargetAFSRestoreInfoProtocol() -> TargetAFSRestoreInfoProtocol {
    return TargetAFSRestoreInfoData()
  }
}
