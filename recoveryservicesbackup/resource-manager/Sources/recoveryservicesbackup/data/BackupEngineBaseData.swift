...
internal struct BackupEngineBaseData : BackupEngineBaseProtocol {
...
extension DataFactory {
  public static func createBackupEngineBaseProtocol() -> BackupEngineBaseProtocol {
    return BackupEngineBaseData()
  }
}
