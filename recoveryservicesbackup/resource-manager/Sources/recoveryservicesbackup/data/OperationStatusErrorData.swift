...
internal struct OperationStatusErrorData : OperationStatusErrorProtocol {
...
extension DataFactory {
  public static func createOperationStatusErrorProtocol() -> OperationStatusErrorProtocol {
    return OperationStatusErrorData()
  }
}
