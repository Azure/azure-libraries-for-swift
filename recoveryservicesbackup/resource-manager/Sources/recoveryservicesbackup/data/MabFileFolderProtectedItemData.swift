...
internal struct MabFileFolderProtectedItemData : MabFileFolderProtectedItemProtocol, ProtectedItemProtocol {
    ...
    public var deferredDeleteSyncTimeInUTC: Int64?
    public var extendedInfo: MabFileFolderProtectedItemExtendedInfoProtocol?
        ...
        case deferredDeleteSyncTimeInUTC = "deferredDeleteSyncTimeInUTC"
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.deferredDeleteSyncTimeInUTC) {
        self.deferredDeleteSyncTimeInUTC = try container.decode(Int64?.self, forKey: .deferredDeleteSyncTimeInUTC)
    }
...
extension DataFactory {
  public static func createMabFileFolderProtectedItemProtocol() -> MabFileFolderProtectedItemProtocol {
    return MabFileFolderProtectedItemData()
  }
}
