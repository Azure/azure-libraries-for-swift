...
internal struct ClientDiscoveryForServiceSpecificationData : ClientDiscoveryForServiceSpecificationProtocol {
    public var logSpecifications: [ClientDiscoveryForLogSpecificationProtocol?]?
...
extension DataFactory {
  public static func createClientDiscoveryForServiceSpecificationProtocol() -> ClientDiscoveryForServiceSpecificationProtocol {
    return ClientDiscoveryForServiceSpecificationData()
  }
}
