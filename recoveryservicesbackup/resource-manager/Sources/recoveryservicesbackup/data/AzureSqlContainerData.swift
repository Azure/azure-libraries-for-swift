...
internal struct AzureSqlContainerData : AzureSqlContainerProtocol, ProtectionContainerProtocol {
...
extension DataFactory {
  public static func createAzureSqlContainerProtocol() -> AzureSqlContainerProtocol {
    return AzureSqlContainerData()
  }
}
