...
internal struct DpmJobExtendedInfoData : DpmJobExtendedInfoProtocol {
    public var tasksList: [DpmJobTaskDetailsProtocol?]?
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
      if container.contains(.tasksList) {
        self.tasksList = try container.decode([DpmJobTaskDetailsData?]?.self, forKey: .tasksList)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.tasksList != nil {try container.encode(self.tasksList as! [DpmJobTaskDetailsData?]?, forKey: .tasksList)}
...
extension DataFactory {
  public static func createDpmJobExtendedInfoProtocol() -> DpmJobExtendedInfoProtocol {
    return DpmJobExtendedInfoData()
  }
}
