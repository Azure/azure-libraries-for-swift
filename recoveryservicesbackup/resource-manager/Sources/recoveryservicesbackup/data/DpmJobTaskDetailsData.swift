...
internal struct DpmJobTaskDetailsData : DpmJobTaskDetailsProtocol {
...
extension DataFactory {
  public static func createDpmJobTaskDetailsProtocol() -> DpmJobTaskDetailsProtocol {
    return DpmJobTaskDetailsData()
  }
}
