...
internal struct AzureStorageJobData : AzureStorageJobProtocol, JobProtocol {
    ...
    public var errorDetails: [AzureStorageErrorInfoProtocol?]?
    public var storageAccountName: String?
    public var storageAccountVersion: String?
    public var extendedInfo: AzureStorageJobExtendedInfoProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.errorDetails) {
        self.errorDetails = try container.decode([AzureStorageErrorInfoData?]?.self, forKey: .errorDetails)
    }
    if container.contains(.storageAccountName) {
    ...
    if container.contains(.extendedInfo) {
        self.extendedInfo = try container.decode(AzureStorageJobExtendedInfoData?.self, forKey: .extendedInfo)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.errorDetails != nil {try container.encode(self.errorDetails as! [AzureStorageErrorInfoData?]?, forKey: .errorDetails)}
    if self.storageAccountName != nil {try container.encode(self.storageAccountName, forKey: .storageAccountName)}
    if self.storageAccountVersion != nil {try container.encode(self.storageAccountVersion, forKey: .storageAccountVersion)}
    if self.extendedInfo != nil {try container.encode(self.extendedInfo as! AzureStorageJobExtendedInfoData?, forKey: .extendedInfo)}
  }
}

extension DataFactory {
  public static func createAzureStorageJobProtocol() -> AzureStorageJobProtocol {
    return AzureStorageJobData()
  }
}
