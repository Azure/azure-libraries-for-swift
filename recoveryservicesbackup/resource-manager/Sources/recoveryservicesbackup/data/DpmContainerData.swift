...
internal struct DpmContainerData : DpmContainerProtocol, ProtectionContainerProtocol {
...
extension DataFactory {
  public static func createDpmContainerProtocol() -> DpmContainerProtocol {
    return DpmContainerData()
  }
}
