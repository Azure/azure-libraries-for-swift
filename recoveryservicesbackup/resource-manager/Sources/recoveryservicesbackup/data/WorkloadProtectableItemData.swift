...
internal struct WorkloadProtectableItemData : WorkloadProtectableItemProtocol {
...
extension DataFactory {
  public static func createWorkloadProtectableItemProtocol() -> WorkloadProtectableItemProtocol {
    return WorkloadProtectableItemData()
  }
}
