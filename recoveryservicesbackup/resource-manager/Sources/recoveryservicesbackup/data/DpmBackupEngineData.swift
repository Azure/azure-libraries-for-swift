...
internal struct DpmBackupEngineData : DpmBackupEngineProtocol, BackupEngineBaseProtocol {
...
extension DataFactory {
  public static func createDpmBackupEngineProtocol() -> DpmBackupEngineProtocol {
    return DpmBackupEngineData()
  }
}
