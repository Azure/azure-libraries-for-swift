...
internal struct BackupResourceConfigData : BackupResourceConfigProtocol {
...
extension DataFactory {
  public static func createBackupResourceConfigProtocol() -> BackupResourceConfigProtocol {
    return BackupResourceConfigData()
  }
}
