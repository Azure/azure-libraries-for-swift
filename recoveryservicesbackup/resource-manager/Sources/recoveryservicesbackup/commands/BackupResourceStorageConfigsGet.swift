...
public protocol BackupResourceStorageConfigsGet  {
    ...
    completionHandler: @escaping (BackupResourceConfigResourceProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.BackupResourceStorageConfigs {
// Get fetches resource storage config.
    internal class GetCommand : BaseCommand, BackupResourceStorageConfigsGet {
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(BackupResourceConfigResourceData?.self, from: data)
                return result;
            }
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: BackupResourceConfigResourceData?, error: Error?) in
