...
public protocol JobsListByResourceGroup  {
...
internal class ListByResourceGroupCommand : BaseCommand, JobsListByResourceGroup {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/jobs"
