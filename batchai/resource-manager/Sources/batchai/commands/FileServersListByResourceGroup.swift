...
public protocol FileServersListByResourceGroup  {
...
// resource group.
internal class ListByResourceGroupCommand : BaseCommand, FileServersListByResourceGroup {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/fileServers"
