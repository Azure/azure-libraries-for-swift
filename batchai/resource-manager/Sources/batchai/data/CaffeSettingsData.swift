...
internal struct CaffeSettingsData : CaffeSettingsProtocol {
    ...
    public var processCount: Int32?
        ...
        enum CodingKeys: String, CodingKey {case configFilePath = "configFilePath"
...
extension DataFactory {
  public static func createCaffeSettingsProtocol() -> CaffeSettingsProtocol {
    return CaffeSettingsData()
  }
}
