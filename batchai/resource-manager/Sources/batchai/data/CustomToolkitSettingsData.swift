...
internal struct CustomToolkitSettingsData : CustomToolkitSettingsProtocol {
...
extension DataFactory {
  public static func createCustomToolkitSettingsProtocol() -> CustomToolkitSettingsProtocol {
    return CustomToolkitSettingsData()
  }
}
