...
internal struct FileServerCreateParametersData : FileServerCreateParametersProtocol {
    public var location: String
    public var tags: [String:String]?
    public var properties: FileServerBasePropertiesProtocol?
...
extension DataFactory {
  public static func createFileServerCreateParametersProtocol(location: String) -> FileServerCreateParametersProtocol {
    return FileServerCreateParametersData(location: location)
  }
}
