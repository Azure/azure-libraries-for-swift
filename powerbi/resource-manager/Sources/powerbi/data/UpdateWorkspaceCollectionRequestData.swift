...
internal struct UpdateWorkspaceCollectionRequestData : UpdateWorkspaceCollectionRequestProtocol {
    public var tags: [String:String]?
    public var sku: AzureSkuProtocol?
...
extension DataFactory {
  public static func createUpdateWorkspaceCollectionRequestProtocol() -> UpdateWorkspaceCollectionRequestProtocol {
    return UpdateWorkspaceCollectionRequestData()
  }
}
