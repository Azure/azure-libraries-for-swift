...
import Foundation
// FileGetFromComputeNodeHeadersProtocol is defines headers for GetFromComputeNode operation.
public protocol FileGetFromComputeNodeHeadersProtocol : Codable {
