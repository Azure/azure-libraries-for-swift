...
import Foundation
// JobPreparationTaskExecutionInformationProtocol is
public protocol JobPreparationTaskExecutionInformationProtocol : Codable {
     var startTime: Date { get set }
     var endTime: Date? { get set }
     var state: JobPreparationTaskStateEnum { get set }
