...
public protocol ComputeNodeDisableScheduling  {
    ...
    var nodeDisableSchedulingParameter :  NodeDisableSchedulingParameterProtocol?  { get set }
...
// DisableScheduling you can disable task scheduling on a node only if its current scheduling state is enabled.
    internal class DisableSchedulingCommand : BaseCommand, ComputeNodeDisableScheduling {
    ...
    public var nodeDisableSchedulingParameter :  NodeDisableSchedulingParameterProtocol?
        ...
        public init(poolId: String, nodeId: String) {
            ...
            self.path = "/pools/{poolId}/nodes/{nodeId}/disablescheduling"
        ...
        public override func preCall()  {
            ...
            self.body = nodeDisableSchedulingParameter
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(nodeDisableSchedulingParameter as? NodeDisableSchedulingParameterData?)
                return encodedValue
            }
