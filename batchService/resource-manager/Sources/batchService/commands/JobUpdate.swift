...
public protocol JobUpdate  {
    ...
    var jobUpdateParameter :  JobUpdateParameterProtocol?  { get set }
...
internal class UpdateCommand : BaseCommand, JobUpdate {
    ...
    public var jobUpdateParameter :  JobUpdateParameterProtocol?

    public init(jobId: String, jobUpdateParameter: JobUpdateParameterProtocol) {
        self.jobId = jobId
        self.jobUpdateParameter = jobUpdateParameter
        super.init()
        self.method = "Put"
    ...
    public override func encodeBody() throws -> Data? {
        ...
        if let mimeType = MimeType.getType(forStr: contentType) {
            ...
            let encodedValue = try encoder.encode(jobUpdateParameter)
            return encodedValue
        }
