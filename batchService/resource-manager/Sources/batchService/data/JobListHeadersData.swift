...
internal struct JobListHeadersData : JobListHeadersProtocol {
...
extension DataFactory {
  public static func createJobListHeadersProtocol() -> JobListHeadersProtocol {
    return JobListHeadersData()
  }
}
