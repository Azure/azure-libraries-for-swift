...
internal struct TaskUpdateHeadersData : TaskUpdateHeadersProtocol {
...
extension DataFactory {
  public static func createTaskUpdateHeadersProtocol() -> TaskUpdateHeadersProtocol {
    return TaskUpdateHeadersData()
  }
}
