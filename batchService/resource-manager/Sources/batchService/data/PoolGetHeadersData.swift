...
internal struct PoolGetHeadersData : PoolGetHeadersProtocol {
...
extension DataFactory {
  public static func createPoolGetHeadersProtocol() -> PoolGetHeadersProtocol {
    return PoolGetHeadersData()
  }
}
