...
internal struct PoolPatchHeadersData : PoolPatchHeadersProtocol {
...
extension DataFactory {
  public static func createPoolPatchHeadersProtocol() -> PoolPatchHeadersProtocol {
    return PoolPatchHeadersData()
  }
}
