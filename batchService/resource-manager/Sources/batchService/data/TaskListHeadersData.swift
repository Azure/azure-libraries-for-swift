...
internal struct TaskListHeadersData : TaskListHeadersProtocol {
...
extension DataFactory {
  public static func createTaskListHeadersProtocol() -> TaskListHeadersProtocol {
    return TaskListHeadersData()
  }
}
