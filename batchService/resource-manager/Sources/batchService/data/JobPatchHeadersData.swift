...
internal struct JobPatchHeadersData : JobPatchHeadersProtocol {
...
extension DataFactory {
  public static func createJobPatchHeadersProtocol() -> JobPatchHeadersProtocol {
    return JobPatchHeadersData()
  }
}
