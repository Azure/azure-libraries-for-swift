...
internal struct PoolAddHeadersData : PoolAddHeadersProtocol {
...
extension DataFactory {
  public static func createPoolAddHeadersProtocol() -> PoolAddHeadersProtocol {
    return PoolAddHeadersData()
  }
}
