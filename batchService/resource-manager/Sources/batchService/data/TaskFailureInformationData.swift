...
internal struct TaskFailureInformationData : TaskFailureInformationProtocol {
...
extension DataFactory {
  public static func createTaskFailureInformationProtocol(category: ErrorCategoryEnum) -> TaskFailureInformationProtocol {
    return TaskFailureInformationData(category: category)
  }
}
