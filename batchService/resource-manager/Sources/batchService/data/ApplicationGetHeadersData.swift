...
internal struct ApplicationGetHeadersData : ApplicationGetHeadersProtocol {
...
extension DataFactory {
  public static func createApplicationGetHeadersProtocol() -> ApplicationGetHeadersProtocol {
    return ApplicationGetHeadersData()
  }
}
