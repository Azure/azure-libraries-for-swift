...
internal struct PoolListHeadersData : PoolListHeadersProtocol {
...
extension DataFactory {
  public static func createPoolListHeadersProtocol() -> PoolListHeadersProtocol {
    return PoolListHeadersData()
  }
}
