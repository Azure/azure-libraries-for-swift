...
internal struct TaskAddHeadersData : TaskAddHeadersProtocol {
...
extension DataFactory {
  public static func createTaskAddHeadersProtocol() -> TaskAddHeadersProtocol {
    return TaskAddHeadersData()
  }
}
