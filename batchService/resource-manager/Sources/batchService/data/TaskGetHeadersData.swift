...
internal struct TaskGetHeadersData : TaskGetHeadersProtocol {
...
extension DataFactory {
  public static func createTaskGetHeadersProtocol() -> TaskGetHeadersProtocol {
    return TaskGetHeadersData()
  }
}
