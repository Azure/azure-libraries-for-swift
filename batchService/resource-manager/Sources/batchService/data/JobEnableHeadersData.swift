...
internal struct JobEnableHeadersData : JobEnableHeadersProtocol {
...
extension DataFactory {
  public static func createJobEnableHeadersProtocol() -> JobEnableHeadersProtocol {
    return JobEnableHeadersData()
  }
}
