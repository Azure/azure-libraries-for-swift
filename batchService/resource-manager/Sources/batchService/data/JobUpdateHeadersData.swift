...
internal struct JobUpdateHeadersData : JobUpdateHeadersProtocol {
...
extension DataFactory {
  public static func createJobUpdateHeadersProtocol() -> JobUpdateHeadersProtocol {
    return JobUpdateHeadersData()
  }
}
