...
internal struct TaskDeleteHeadersData : TaskDeleteHeadersProtocol {
...
extension DataFactory {
  public static func createTaskDeleteHeadersProtocol() -> TaskDeleteHeadersProtocol {
    return TaskDeleteHeadersData()
  }
}
