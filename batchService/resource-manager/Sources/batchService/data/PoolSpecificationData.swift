...
internal struct PoolSpecificationData : PoolSpecificationProtocol {
...
extension DataFactory {
  public static func createPoolSpecificationProtocol(vmSize: String) -> PoolSpecificationProtocol {
    return PoolSpecificationData(vmSize: vmSize)
  }
}
