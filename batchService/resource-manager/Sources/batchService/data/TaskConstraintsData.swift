...
internal struct TaskConstraintsData : TaskConstraintsProtocol {
...
extension DataFactory {
  public static func createTaskConstraintsProtocol() -> TaskConstraintsProtocol {
    return TaskConstraintsData()
  }
}
