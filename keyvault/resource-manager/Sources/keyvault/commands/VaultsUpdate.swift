...
public protocol VaultsUpdate  {
    ...
    var parameters :  VaultPatchParametersProtocol?  { get set }
...
// Update update a key vault in the specified subscription.
    ...
    public var parameters :  VaultPatchParametersProtocol?

        public init(resourceGroupName: String, vaultName: String, subscriptionId: String, parameters: VaultPatchParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? VaultPatchParametersData)
                return encodedValue
            }
