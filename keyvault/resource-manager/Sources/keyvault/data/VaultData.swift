...
internal struct VaultData : VaultProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createVaultProtocol(location: String, properties: VaultPropertiesProtocol) -> VaultProtocol {
    return VaultData(location: location, properties: properties)
  }
}
