...
internal struct OperationData : OperationProtocol {
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.operationProperties) {
        self.operationProperties = try container.decode(OperationPropertiesData?.self, forKey: .operationProperties)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.operationProperties != nil {try container.encode(self.operationProperties as! OperationPropertiesData?, forKey: .operationProperties)}
  }
}
