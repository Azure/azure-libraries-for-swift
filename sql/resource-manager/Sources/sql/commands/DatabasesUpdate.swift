...
public protocol DatabasesUpdate  {
    ...
    var parameters :  DatabaseUpdateProtocol?  { get set }
...
// cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class UpdateCommand : BaseCommand, DatabasesUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var serverName : String
        public var databaseName : String
        public var apiVersion = "2014-04-01"
    public var parameters :  DatabaseUpdateProtocol?

        public init(subscriptionId: String, resourceGroupName: String, serverName: String, databaseName: String, parameters: DatabaseUpdateProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? DatabaseUpdateData)
                return encodedValue
            }
