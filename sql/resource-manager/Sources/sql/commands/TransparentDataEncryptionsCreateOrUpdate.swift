...
// CreateOrUpdate creates or updates a database's transparent data encryption configuration.
    internal class CreateOrUpdateCommand : BaseCommand, TransparentDataEncryptionsCreateOrUpdate {
    ...
    public var parameters :  TransparentDataEncryptionProtocol?

        public init(subscriptionId: String, resourceGroupName: String, serverName: String, databaseName: String, transparentDataEncryptionName: String, parameters: TransparentDataEncryptionProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? TransparentDataEncryptionData)
                return encodedValue
            }
