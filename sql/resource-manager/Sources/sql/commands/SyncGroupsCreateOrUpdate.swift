...
public protocol SyncGroupsCreateOrUpdate  {
...
// passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, SyncGroupsCreateOrUpdate {
    ...
    public var parameters :  SyncGroupProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? SyncGroupData)
                return encodedValue
            }
