...
public protocol FailoverGroupsFailover  {
...
// HTTP requests.
internal class FailoverCommand : BaseCommand, FailoverGroupsFailover {
    ...
    public init(resourceGroupName: String, serverName: String, failoverGroupName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/failoverGroups/{failoverGroupName}/failover"
