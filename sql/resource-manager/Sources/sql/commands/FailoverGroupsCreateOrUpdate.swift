...
public protocol FailoverGroupsCreateOrUpdate  {
    ...
    var parameters :  FailoverGroupProtocol?  { get set }
...
// passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, FailoverGroupsCreateOrUpdate {
        public var resourceGroupName : String
        public var serverName : String
        public var failoverGroupName : String
        public var subscriptionId : String
        public var apiVersion = "2015-05-01-preview"
    public var parameters :  FailoverGroupProtocol?

        public init(resourceGroupName: String, serverName: String, failoverGroupName: String, subscriptionId: String, parameters: FailoverGroupProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? FailoverGroupData)
                return encodedValue
            }
