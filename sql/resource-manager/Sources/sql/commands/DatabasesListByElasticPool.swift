...
public protocol DatabasesListByElasticPool  {
...
internal class ListByElasticPoolCommand : BaseCommand, DatabasesListByElasticPool {
    var nextLink: String?
    ...
    public init(subscriptionId: String, resourceGroupName: String, serverName: String, elasticPoolName: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/databases"
