...
public protocol GeoBackupPoliciesCreateOrUpdate  {
    ...
    var parameters :  GeoBackupPolicyProtocol?  { get set }
...
// CreateOrUpdate updates a database geo backup policy.
    internal class CreateOrUpdateCommand : BaseCommand, GeoBackupPoliciesCreateOrUpdate {
    ...
    public var parameters :  GeoBackupPolicyProtocol?

        public init(subscriptionId: String, resourceGroupName: String, serverName: String, databaseName: String, geoBackupPolicyName: String, parameters: GeoBackupPolicyProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? GeoBackupPolicyData)
                return encodedValue
            }
