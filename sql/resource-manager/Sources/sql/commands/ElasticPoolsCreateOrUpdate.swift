...
public protocol ElasticPoolsCreateOrUpdate  {
    ...
    var parameters :  ElasticPoolProtocol?  { get set }
...
// outstanding HTTP requests.
    internal class CreateOrUpdateCommand : BaseCommand, ElasticPoolsCreateOrUpdate {
        public var subscriptionId : String
        public var resourceGroupName : String
        public var serverName : String
        public var elasticPoolName : String
        public var apiVersion = "2014-04-01"
    public var parameters :  ElasticPoolProtocol?

        public init(subscriptionId: String, resourceGroupName: String, serverName: String, elasticPoolName: String, parameters: ElasticPoolProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ElasticPoolData)
                return encodedValue
            }
