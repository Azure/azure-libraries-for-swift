...
internal struct SyncGroupSchemaTableColumnData : SyncGroupSchemaTableColumnProtocol {
    public var quotedName: String?
    public var dataSize: String?
    public var dataType: String?

        enum CodingKeys: String, CodingKey {case quotedName = "quotedName"
...
extension DataFactory {
  public static func createSyncGroupSchemaTableColumnProtocol() -> SyncGroupSchemaTableColumnProtocol {
    return SyncGroupSchemaTableColumnData()
  }
}
