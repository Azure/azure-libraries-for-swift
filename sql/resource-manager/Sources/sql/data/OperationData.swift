...
internal struct OperationData : OperationProtocol {
    ...
    public var origin: OperationOriginEnum?
    public var properties: [String:[String: String?]]?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.origin) {
        self.origin = try container.decode(OperationOriginEnum?.self, forKey: .origin)
    }
    if container.contains(.properties) {
        self.properties = try container.decode([String:[String: String?]]?.self, forKey: .properties)
    }
