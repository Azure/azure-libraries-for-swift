...
internal struct FirewallRulePropertiesData : FirewallRulePropertiesProtocol {
...
extension DataFactory {
  public static func createFirewallRulePropertiesProtocol(startIpAddress: String, endIpAddress: String) -> FirewallRulePropertiesProtocol {
    return FirewallRulePropertiesData(startIpAddress: startIpAddress, endIpAddress: endIpAddress)
  }
}
