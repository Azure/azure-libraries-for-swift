...
internal struct AutomaticTuningServerOptionsData : AutomaticTuningServerOptionsProtocol {
    ...
    public var reasonDesc: AutomaticTuningServerReasonEnum?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.reasonDesc) {
        self.reasonDesc = try container.decode(AutomaticTuningServerReasonEnum?.self, forKey: .reasonDesc)
    }
...
extension DataFactory {
  public static func createAutomaticTuningServerOptionsProtocol() -> AutomaticTuningServerOptionsProtocol {
    return AutomaticTuningServerOptionsData()
  }
}
