...
internal struct ServerData : ServerProtocol, TrackedResourceProtocol, ResourceProtocol {
    public var id: String?
    public var name: String?
    public var type: String?
    public var tags: [String:String]?
    public var location: String
    public var identity: ResourceIdentityProtocol?
    public var kind: String?
    public var properties: ServerPropertiesProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.identity) {
        self.identity = try container.decode(ResourceIdentityData?.self, forKey: .identity)
    }
...
extension DataFactory {
  public static func createServerProtocol(location: String) -> ServerProtocol {
    return ServerData(location: location)
  }
}
