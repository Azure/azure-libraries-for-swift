...
internal struct ElasticPoolEditionCapabilityData : ElasticPoolEditionCapabilityProtocol {
    public var name: String?
    public var status: CapabilityStatusEnum?
    public var supportedElasticPoolDtus: [ElasticPoolDtuCapabilityProtocol?]?
    public var zoneRedundant: Bool?

        enum CodingKeys: String, CodingKey {case name = "name"
        case status = "status"
        case supportedElasticPoolDtus = "supportedElasticPoolDtus"
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.supportedElasticPoolDtus) {
        self.supportedElasticPoolDtus = try container.decode([ElasticPoolDtuCapabilityData?]?.self, forKey: .supportedElasticPoolDtus)
    }
...
extension DataFactory {
  public static func createElasticPoolEditionCapabilityProtocol() -> ElasticPoolEditionCapabilityProtocol {
    return ElasticPoolEditionCapabilityData()
  }
}
