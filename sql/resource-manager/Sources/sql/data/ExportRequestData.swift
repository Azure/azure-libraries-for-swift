...
internal struct ExportRequestData : ExportRequestProtocol {
...
extension DataFactory {
  public static func createExportRequestProtocol(storageKeyType: StorageKeyTypeEnum, storageKey: String, storageUri: String, administratorLogin: String, administratorLoginPassword: String) -> ExportRequestProtocol {
    return ExportRequestData(storageKeyType: storageKeyType, storageKey: storageKey, storageUri: storageUri, administratorLogin: administratorLogin, administratorLoginPassword: administratorLoginPassword)
  }
}
