...
internal struct PatchTrackedResourceData : PatchTrackedResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createPatchTrackedResourceProtocol() -> PatchTrackedResourceProtocol {
    return PatchTrackedResourceData()
  }
}
