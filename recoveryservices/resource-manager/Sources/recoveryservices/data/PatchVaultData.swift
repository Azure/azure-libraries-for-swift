...
internal struct PatchVaultData : PatchVaultProtocol, PatchTrackedResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createPatchVaultProtocol() -> PatchVaultProtocol {
    return PatchVaultData()
  }
}
