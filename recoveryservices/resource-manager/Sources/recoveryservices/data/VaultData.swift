...
internal struct VaultData : VaultProtocol, TrackedResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createVaultProtocol(location: String) -> VaultProtocol {
    return VaultData(location: location)
  }
}
