...
public protocol ProfilesListResourceUsage  {
...
// ListResourceUsage checks the quota and actual usage of endpoints under the given CDN profile.
    internal class ListResourceUsageCommand : BaseCommand, ProfilesListResourceUsage {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, profileName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/checkResourceUsage"
