...
public protocol ResourceUsageList  {
...
extension Commands.ResourceUsage {
// List check the quota and actual usage of the CDN profiles under the given subscription.
internal class ListCommand : BaseCommand, ResourceUsageList {
    var nextLink: String?
    ...
    public init(subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Cdn/checkResourceUsage"
