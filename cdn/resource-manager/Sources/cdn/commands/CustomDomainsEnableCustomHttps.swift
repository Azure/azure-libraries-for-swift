...
public protocol CustomDomainsEnableCustomHttps  {
...
internal class EnableCustomHttpsCommand : BaseCommand, CustomDomainsEnableCustomHttps {
    ...
    public init(resourceGroupName: String, profileName: String, endpointName: String, customDomainName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/customDomains/{customDomainName}/enableCustomHttps"
