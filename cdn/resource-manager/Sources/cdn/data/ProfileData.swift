...
internal struct ProfileData : ProfileProtocol, TrackedResourceProtocol, ResourceProtocol {
    ...
    public var properties: ProfilePropertiesProtocol?
...
extension DataFactory {
  public static func createProfileProtocol(location: String, sku: SkuProtocol) -> ProfileProtocol {
    return ProfileData(location: location, sku: sku)
  }
}
