...
internal struct ValidateProbeOutputData : ValidateProbeOutputProtocol {
    public var isValid: Bool?
    public var errorCode: String?
    public var message: String?

        enum CodingKeys: String, CodingKey {case isValid = "isValid"
...
extension DataFactory {
  public static func createValidateProbeOutputProtocol() -> ValidateProbeOutputProtocol {
    return ValidateProbeOutputData()
  }
}
