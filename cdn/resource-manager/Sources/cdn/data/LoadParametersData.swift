...
internal struct LoadParametersData : LoadParametersProtocol {
...
extension DataFactory {
  public static func createLoadParametersProtocol(contentPaths: [String]) -> LoadParametersProtocol {
    return LoadParametersData(contentPaths: contentPaths)
  }
}
