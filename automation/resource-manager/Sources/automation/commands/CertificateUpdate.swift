...
public protocol CertificateUpdate  {
    ...
    var parameters :  CertificateUpdateParametersProtocol?  { get set }
...
// Update update a certificate.
    ...
    public var parameters :  CertificateUpdateParametersProtocol?

        public init(resourceGroupName: String, automationAccountName: String, certificateName: String, subscriptionId: String, parameters: CertificateUpdateParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? CertificateUpdateParametersData)
                return encodedValue
            }
