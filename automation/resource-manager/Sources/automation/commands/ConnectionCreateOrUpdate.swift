...
public protocol ConnectionCreateOrUpdate  {
    ...
    var parameters :  ConnectionCreateOrUpdateParametersProtocol?  { get set }
...
// CreateOrUpdate create or update a connection.
    internal class CreateOrUpdateCommand : BaseCommand, ConnectionCreateOrUpdate {
        public var resourceGroupName : String
        public var automationAccountName : String
        public var connectionName : String
        public var subscriptionId : String
        public var apiVersion = "2015-10-31"
    public var parameters :  ConnectionCreateOrUpdateParametersProtocol?

        public init(resourceGroupName: String, automationAccountName: String, connectionName: String, subscriptionId: String, parameters: ConnectionCreateOrUpdateParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ConnectionCreateOrUpdateParametersData)
                return encodedValue
            }
