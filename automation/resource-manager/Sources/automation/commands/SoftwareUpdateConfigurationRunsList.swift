...
// List return list of software update configuration runs
    internal class ListCommand : BaseCommand, SoftwareUpdateConfigurationRunsList {
        ...
        public init(subscriptionId: String, resourceGroupName: String, automationAccountName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/softwareUpdateConfigurationRuns"
