...
public protocol TestJobsCreate  {
...
internal class CreateCommand : BaseCommand, TestJobsCreate {
    ...
    public init(resourceGroupName: String, automationAccountName: String, runbookName: String, subscriptionId: String, parameters: TestJobCreateParametersProtocol) {
