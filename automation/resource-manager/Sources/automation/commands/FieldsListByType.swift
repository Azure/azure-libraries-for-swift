...
public protocol FieldsListByType  {
...
extension Commands.Fields {
// ListByType retrieve a list of fields of a given type identified by module name.
    internal class ListByTypeCommand : BaseCommand, FieldsListByType {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, automationAccountName: String, moduleName: String, typeName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/modules/{moduleName}/types/{typeName}/fields"
