...
public protocol CredentialUpdate  {
    ...
    var parameters :  CredentialUpdateParametersProtocol?  { get set }
...
// Update update a credential.
    internal class UpdateCommand : BaseCommand, CredentialUpdate {
        public var resourceGroupName : String
        public var automationAccountName : String
        public var credentialName : String
        public var subscriptionId : String
        public var apiVersion = "2015-10-31"
    public var parameters :  CredentialUpdateParametersProtocol?

        public init(resourceGroupName: String, automationAccountName: String, credentialName: String, subscriptionId: String, parameters: CredentialUpdateParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? CredentialUpdateParametersData)
                return encodedValue
            }
