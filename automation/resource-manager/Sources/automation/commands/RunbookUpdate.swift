...
// Update update the runbook identified by runbook name.
    ...
    public var parameters :  RunbookUpdateParametersProtocol?
        ...
        public init(subscriptionId: String, resourceGroupName: String, automationAccountName: String, runbookName: String, parameters: RunbookUpdateParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? RunbookUpdateParametersData)
                return encodedValue
            }
