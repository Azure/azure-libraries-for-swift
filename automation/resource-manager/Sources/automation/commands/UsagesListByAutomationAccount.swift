...
public protocol UsagesListByAutomationAccount  {
...
internal class ListByAutomationAccountCommand : BaseCommand, UsagesListByAutomationAccount {
    var nextLink: String?
    ...
    public init(resourceGroupName: String, automationAccountName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/usages"
