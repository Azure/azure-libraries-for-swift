...
internal class GetCommand : BaseCommand, JobStreamGet {
    ...
    public init(resourceGroupName: String, automationAccountName: String, jobId: String, jobStreamId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/jobs/{jobId}/streams/{jobStreamId}"
