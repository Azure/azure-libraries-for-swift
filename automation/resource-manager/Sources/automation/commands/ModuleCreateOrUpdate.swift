...
public protocol ModuleCreateOrUpdate  {
    ...
    var parameters :  ModuleCreateOrUpdateParametersProtocol?  { get set }
...
// CreateOrUpdate create or Update the module identified by module name.
    internal class CreateOrUpdateCommand : BaseCommand, ModuleCreateOrUpdate {
        public var resourceGroupName : String
        public var automationAccountName : String
        public var moduleName : String
        public var subscriptionId : String
        public var apiVersion = "2015-10-31"
    public var parameters :  ModuleCreateOrUpdateParametersProtocol?

        public init(resourceGroupName: String, automationAccountName: String, moduleName: String, subscriptionId: String, parameters: ModuleCreateOrUpdateParametersProtocol) {
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(parameters as? ModuleCreateOrUpdateParametersData)
                return encodedValue
            }
