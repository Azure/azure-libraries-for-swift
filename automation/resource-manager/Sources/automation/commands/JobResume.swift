...
// Resume resume the job identified by jobName.
    internal class ResumeCommand : BaseCommand, JobResume {
        ...
        public init(resourceGroupName: String, automationAccountName: String, jobName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/jobs/{jobName}/resume"
