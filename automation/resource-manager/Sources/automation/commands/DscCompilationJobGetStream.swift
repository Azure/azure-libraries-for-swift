...
public protocol DscCompilationJobGetStream  {
...
internal class GetStreamCommand : BaseCommand, DscCompilationJobGetStream {
    ...
    public init(resourceGroupName: String, automationAccountName: String, jobId: String, jobStreamId: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/compilationjobs/{jobId}/streams/{jobStreamId}"
