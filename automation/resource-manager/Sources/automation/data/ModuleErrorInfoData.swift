...
internal struct ModuleErrorInfoData : ModuleErrorInfoProtocol {
...
extension DataFactory {
  public static func createModuleErrorInfoProtocol() -> ModuleErrorInfoProtocol {
    return ModuleErrorInfoData()
  }
}
