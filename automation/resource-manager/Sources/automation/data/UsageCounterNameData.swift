...
internal struct UsageCounterNameData : UsageCounterNameProtocol {
...
extension DataFactory {
  public static func createUsageCounterNameProtocol() -> UsageCounterNameProtocol {
    return UsageCounterNameData()
  }
}
