...
// ListAuthorizationRules authorization rules for a WCF relay.
    internal class ListAuthorizationRulesCommand : BaseCommand, WCFRelaysListAuthorizationRules {
        var nextLink: String?
        ...
        public init(resourceGroupName: String, namespaceName: String, relayName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}/authorizationRules"
