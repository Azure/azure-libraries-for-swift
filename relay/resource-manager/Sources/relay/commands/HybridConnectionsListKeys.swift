...
public protocol HybridConnectionsListKeys  {
...
// ListKeys primary and secondary connection strings to the hybrid connection.
    internal class ListKeysCommand : BaseCommand, HybridConnectionsListKeys {
        ...
        public init(resourceGroupName: String, namespaceName: String, hybridConnectionName: String, authorizationRuleName: String, subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/hybridConnections/{hybridConnectionName}/authorizationRules/{authorizationRuleName}/listKeys"
