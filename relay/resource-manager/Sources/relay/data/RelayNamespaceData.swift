...
internal struct RelayNamespaceData : RelayNamespaceProtocol, TrackedResourceProtocol, ResourceProtocol {
...
extension DataFactory {
  public static func createRelayNamespaceProtocol(location: String) -> RelayNamespaceProtocol {
    return RelayNamespaceData(location: location)
  }
}
