...
internal struct RelayNamespacePropertiesData : RelayNamespacePropertiesProtocol {
    public var provisioningState: ProvisioningStateEnumEnum?
  ...
  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
      if container.contains(.provisioningState) {
        self.provisioningState = try container.decode(ProvisioningStateEnumEnum?.self, forKey: .provisioningState)
    }
...
extension DataFactory {
  public static func createRelayNamespacePropertiesProtocol() -> RelayNamespacePropertiesProtocol {
    return RelayNamespacePropertiesData()
  }
}
