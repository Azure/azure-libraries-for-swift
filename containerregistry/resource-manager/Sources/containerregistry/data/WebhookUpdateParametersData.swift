...
internal struct WebhookUpdateParametersData : WebhookUpdateParametersProtocol {
    ...
    public var properties: WebhookPropertiesUpdateParametersProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.properties) {
        self.properties = try container.decode(WebhookPropertiesUpdateParametersData?.self, forKey: .properties)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.properties != nil {try container.encode(self.properties as! WebhookPropertiesUpdateParametersData?, forKey: .properties)}
  }
}
