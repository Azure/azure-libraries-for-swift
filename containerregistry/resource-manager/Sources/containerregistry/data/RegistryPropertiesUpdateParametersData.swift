...
internal struct RegistryPropertiesUpdateParametersData : RegistryPropertiesUpdateParametersProtocol {
    public var adminUserEnabled: Bool?
    public var storageAccount: StorageAccountPropertiesProtocol?

        enum CodingKeys: String, CodingKey {case adminUserEnabled = "adminUserEnabled"
...
extension DataFactory {
  public static func createRegistryPropertiesUpdateParametersProtocol() -> RegistryPropertiesUpdateParametersProtocol {
    return RegistryPropertiesUpdateParametersData()
  }
}
