...
internal struct RedisLinkedServerCreatePropertiesData : RedisLinkedServerCreatePropertiesProtocol {
...
extension DataFactory {
  public static func createRedisLinkedServerCreatePropertiesProtocol(linkedRedisCacheId: String, linkedRedisCacheLocation: String, serverRole: ReplicationRoleEnum) -> RedisLinkedServerCreatePropertiesProtocol {
    return RedisLinkedServerCreatePropertiesData(linkedRedisCacheId: linkedRedisCacheId, linkedRedisCacheLocation: linkedRedisCacheLocation, serverRole: serverRole)
  }
}
