...
public protocol JobsCreateOrUpdate  {
...
// CreateOrUpdate provisions a new job or updates an existing job.
    internal class CreateOrUpdateCommand : BaseCommand, JobsCreateOrUpdate {
    ...
    public var job :  JobDefinitionProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(job as? JobDefinitionData)
                return encodedValue
            }
