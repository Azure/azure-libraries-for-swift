...
public protocol JobCollectionsCreateOrUpdate  {
...
// CreateOrUpdate provisions a new job collection or updates an existing job collection.
    internal class CreateOrUpdateCommand : BaseCommand, JobCollectionsCreateOrUpdate {
    ...
    public var jobCollection :  JobCollectionDefinitionProtocol?
        ...
        public override func encodeBody() throws -> Data? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let encodedValue = try encoder.encode(jobCollection as? JobCollectionDefinitionData)
                return encodedValue
            }
