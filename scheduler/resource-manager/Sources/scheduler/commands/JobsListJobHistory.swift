...
public protocol JobsListJobHistory  {
    ...
    completionHandler: @escaping (JobHistoryListResultProtocol?, Error?) -> Void) -> Void ;
}

extension Commands.Jobs {
// ListJobHistory lists job history.
    internal class ListJobHistoryCommand : BaseCommand, JobsListJobHistory {
        var nextLink: String?
        ...
        public init(subscriptionId: String, resourceGroupName: String, jobCollectionName: String, jobName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections/{jobCollectionName}/jobs/{jobName}/history"
        ...
        public override func returnFunc(data: Data) throws -> Decodable? {
            ...
            if let mimeType = MimeType.getType(forStr: contentType) {
                ...
                let result = try decoder.decode(JobHistoryListResultData?.self, from: data)
                if var pageDecoder = decoder as? PageDecoder {
        ...
        public func execute(client: RuntimeClient,
            ...
            client.executeAsync(command: self) {
                (result: JobHistoryListResultData?, error: Error?) in
