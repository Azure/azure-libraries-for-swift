...
public protocol JobCollectionsListBySubscription  {
...
// ListBySubscription gets all job collections under specified subscription.
    internal class ListBySubscriptionCommand : BaseCommand, JobCollectionsListBySubscription {
        var nextLink: String?
        ...
        public init(subscriptionId: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/providers/Microsoft.Scheduler/jobCollections"
