...
public protocol JobCollectionsDisable  {
...
// requests.
    internal class DisableCommand : BaseCommand, JobCollectionsDisable {
        ...
        public init(subscriptionId: String, resourceGroupName: String, jobCollectionName: String) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections/{jobCollectionName}/disable"
