...
internal struct ServiceBusTopicMessageData : ServiceBusTopicMessageProtocol, ServiceBusMessageProtocol {
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.topicPath) {
        self.topicPath = try container.decode(String?.self, forKey: .topicPath)
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.topicPath != nil {try container.encode(self.topicPath, forKey: .topicPath)}
  }
}

extension DataFactory {
  public static func createServiceBusTopicMessageProtocol() -> ServiceBusTopicMessageProtocol {
    return ServiceBusTopicMessageData()
  }
}
