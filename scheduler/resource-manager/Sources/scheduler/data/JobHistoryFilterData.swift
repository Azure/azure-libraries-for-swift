...
internal struct JobHistoryFilterData : JobHistoryFilterProtocol {
...
extension DataFactory {
  public static func createJobHistoryFilterProtocol() -> JobHistoryFilterProtocol {
    return JobHistoryFilterData()
  }
}
