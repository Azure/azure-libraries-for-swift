...
public protocol AuthorizationPoliciesRegenerateSecondaryKey  {
...
internal class RegenerateSecondaryKeyCommand : BaseCommand, AuthorizationPoliciesRegenerateSecondaryKey {
    ...
    public init(resourceGroupName: String, hubName: String, authorizationPolicyName: String, subscriptionId: String) {
        ...
        self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/authorizationPolicies/{authorizationPolicyName}/regenerateSecondaryKey"
