...
public protocol ImagesGetUploadUrlForEntityType  {
...
// GetUploadUrlForEntityType gets entity type (profile or interaction) image upload URL.
    internal class GetUploadUrlForEntityTypeCommand : BaseCommand, ImagesGetUploadUrlForEntityType {
    ...
    public var parameters :  GetImageUploadUrlInputProtocol?
        ...
        public init(resourceGroupName: String, hubName: String, subscriptionId: String, parameters: GetImageUploadUrlInputProtocol) {
            ...
            self.path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/images/getEntityTypeImageUploadUrl"
